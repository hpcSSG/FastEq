...
std::vector<torch::Tensor> spherical_harmonics_forward(torch::Tensor xyz) {
    ...
    AT_DISPATCH_FLOATING_TYPES(
        ...
        cudaError_t err = cudaFuncSetAttribute( spherical_harmonics_kernel_ptr<scalar_t>, cudaFuncAttributeMaxDynamicSharedMemorySize, (int)space);
...
torch::Tensor spherical_harmonics_backward(torch::Tensor sph_deriv,
  ...
  AT_DISPATCH_FLOATING_TYPES(
      sph_deriv.scalar_type(), "spherical_harmonics_backward_kernel_ptr", ([&] {
        ...
        //cudaError_t err = cudaFuncSetAttribute( spherical_harmonics_backward_kernel_ptr<scalar_t>, cudaFuncAttributeMaxDynamicSharedMemorySize, (int)space);
        //TORCH_CHECK(err == cudaSuccess, "cudaFuncSetAttribute failed: ", cudaGetErrorString(err));
