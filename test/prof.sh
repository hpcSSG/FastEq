...
# fasteq
KREGEX='tp_channel_wise_sparse_groupk_kernel|tp_bwd_fused_kernel_sharedc|tp_channel_wise_sparse_groupk_fused_scatter_sender_major_kernel|tp17_bwd_fused_sender_major_densec_kernel|fused_fctp_kernel_fwd_multipath_tiledW|fused_fctp_kernel_bwd_grad_a_multipath_tiledU|stc_fwd_kernel_notiled|stc_bwd_kernel_v1|stc_bwd_kernel_tiled|mutipath_equi_linear_f32_tf32_kernel|mutipath_equi_linear_f64_f64_kernel'
