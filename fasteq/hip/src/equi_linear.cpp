...
)
{
    ...
    uint32_t real_smem_ptr =
        static_cast<uint32_t>(reinterpret_cast<uintptr_t>(smem_ptr0 + smem_offset));
...
#pragma unroll
    ...
    hipFuncSetAttribute((const void *)hip_kernel, hipFuncAttributePreferredSharedMemoryCarveout, 57); // 128 KB （128/228）
