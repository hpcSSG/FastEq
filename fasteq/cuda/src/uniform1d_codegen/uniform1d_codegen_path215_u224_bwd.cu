...
__global__ void uniform1d_codegen_blocku_vgroup_path215_u224_bwd(
    ...
    int B, int Iw, int Ix, int Ky, int V, int U)
{
    ...
    if (lane == 0) smem[2 * num_warps + warp_id] = gy_warp_k_12;
    ...
    if (lane == 0) smem[3 * num_warps + warp_id] = gy_warp_k_14;
    ...
    if (lane == 0) smem[5 * num_warps + warp_id] = gy_warp_k_10;
    ...
    if (lane == 0) smem[6 * num_warps + warp_id] = gy_warp_k_9;
    ...
    if (lane == 0) smem[7 * num_warps + warp_id] = gy_warp_k_5;
    ...
    if (lane == 0) smem[8 * num_warps + warp_id] = gy_warp_k_4;
    ...
    if (lane == 0) smem[9 * num_warps + warp_id] = gy_warp_k_7;
    ...
    if (lane == 0) smem[12 * num_warps + warp_id] = gy_warp_k_3;
    ...
    if (lane == 0) smem[13 * num_warps + warp_id] = gy_warp_k_2;
    ...
    if (lane == 0) smem[14 * num_warps + warp_id] = gy_warp_k_1;
    ...
    if (warp_id == 0) {
        ...
        if (red_lane < num_warps) block_sum_k_12 = smem[2 * num_warps + red_lane];
        ...
        if (red_lane < num_warps) block_sum_k_14 = smem[3 * num_warps + red_lane];
        ...
        if (red_lane < num_warps) block_sum_k_10 = smem[5 * num_warps + red_lane];
        ...
        if (red_lane < num_warps) block_sum_k_9 = smem[6 * num_warps + red_lane];
        ...
        if (red_lane < num_warps) block_sum_k_5 = smem[7 * num_warps + red_lane];
        ...
        if (red_lane < num_warps) block_sum_k_4 = smem[8 * num_warps + red_lane];
        ...
        if (red_lane < num_warps) block_sum_k_7 = smem[9 * num_warps + red_lane];
        ...
        if (red_lane < num_warps) block_sum_k_3 = smem[12 * num_warps + red_lane];
        ...
        if (red_lane < num_warps) block_sum_k_2 = smem[13 * num_warps + red_lane];
        ...
        if (red_lane < num_warps) block_sum_k_1 = smem[14 * num_warps + red_lane];
...
template <typename scalar_t>
void launch_uniform1d_codegen_blocku_vgroup_path215_u224_bwd(
    const scalar_t* w,
    ...
    cudaStream_t stream)
{
    ...
    dim3 block(U);
    dim3 grid(B);
    uniform1d_codegen_blocku_vgroup_path215_u224_bwd<scalar_t><<<grid, block, smem_bytes, stream>>>(
