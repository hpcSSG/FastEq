...
__launch_bounds__(32, 8) __global__ void uniform1d_split_bwd_u128_p16_gradw(
    ...
    int B, int Iw, int Ix, int Ky, int V)
{
    ...
    // target i = 1
    {
        ...
        scalar_t x_j_0 = x_all[x_base + ((int64_t)0 << 5)];
        acc_i_1 = fma((scalar_t)(1.0) * x_j_0, y_k_1 * go_v_1, acc_i_1);
    }
    {
        scalar_t y_k_2 = y[y_base + 2];
        scalar_t go_v_2 = grad_out[go_base + ((int64_t)2 << 5)];
        scalar_t x_j_0 = x_all[x_base + ((int64_t)0 << 5)];
        acc_i_1 = fma((scalar_t)(1.0) * x_j_0, y_k_2 * go_v_2, acc_i_1);
    }
    {
        scalar_t y_k_3 = y[y_base + 3];
        scalar_t go_v_3 = grad_out[go_base + ((int64_t)3 << 5)];
        scalar_t x_j_0 = x_all[x_base + ((int64_t)0 << 5)];
        acc_i_1 = fma((scalar_t)(1.0) * x_j_0, y_k_3 * go_v_3, acc_i_1);
    }
...
template <typename scalar_t>
__launch_bounds__(32, 8) __global__ void uniform1d_split_bwd_u128_p16_gradx(
    const scalar_t* __restrict__ grad_out,
    ...
    int B, int Iw, int Ix, int Ky, int V)
{
    ...
    }
    {
        ...
        scalar_t y_k_1 = y[y_base + 1];
        scalar_t go_v_1 = grad_out[go_base + ((int64_t)1 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_1, y_k_1 * go_v_1, acc_j_0);
    }
    {
        scalar_t w_i_1 = w[w_base + ((int64_t)1 << 5)];
        scalar_t y_k_2 = y[y_base + 2];
        scalar_t go_v_2 = grad_out[go_base + ((int64_t)2 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_1, y_k_2 * go_v_2, acc_j_0);
    }
    {
        scalar_t w_i_1 = w[w_base + ((int64_t)1 << 5)];
        scalar_t y_k_3 = y[y_base + 3];
        scalar_t go_v_3 = grad_out[go_base + ((int64_t)3 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_1, y_k_3 * go_v_3, acc_j_0);
    }
    {
        scalar_t w_i_2 = w[w_base + ((int64_t)2 << 5)];
        scalar_t y_k_4 = y[y_base + 4];
        scalar_t go_v_4 = grad_out[go_base + ((int64_t)4 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_2, y_k_4 * go_v_4, acc_j_0);
    }
    {
        scalar_t w_i_2 = w[w_base + ((int64_t)2 << 5)];
        scalar_t y_k_5 = y[y_base + 5];
        scalar_t go_v_5 = grad_out[go_base + ((int64_t)5 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_2, y_k_5 * go_v_5, acc_j_0);
    }
    {
        scalar_t w_i_2 = w[w_base + ((int64_t)2 << 5)];
        scalar_t y_k_6 = y[y_base + 6];
        scalar_t go_v_6 = grad_out[go_base + ((int64_t)6 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_2, y_k_6 * go_v_6, acc_j_0);
    }
    {
        scalar_t w_i_2 = w[w_base + ((int64_t)2 << 5)];
        scalar_t y_k_7 = y[y_base + 7];
        scalar_t go_v_7 = grad_out[go_base + ((int64_t)7 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_2, y_k_7 * go_v_7, acc_j_0);
    }
    {
        scalar_t w_i_2 = w[w_base + ((int64_t)2 << 5)];
        scalar_t y_k_8 = y[y_base + 8];
        scalar_t go_v_8 = grad_out[go_base + ((int64_t)8 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_2, y_k_8 * go_v_8, acc_j_0);
    }
    {
        scalar_t w_i_3 = w[w_base + ((int64_t)3 << 5)];
        scalar_t y_k_9 = y[y_base + 9];
        scalar_t go_v_9 = grad_out[go_base + ((int64_t)9 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_3, y_k_9 * go_v_9, acc_j_0);
    }
    {
        scalar_t w_i_3 = w[w_base + ((int64_t)3 << 5)];
        scalar_t y_k_10 = y[y_base + 10];
        scalar_t go_v_10 = grad_out[go_base + ((int64_t)10 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_3, y_k_10 * go_v_10, acc_j_0);
    }
    {
        scalar_t w_i_3 = w[w_base + ((int64_t)3 << 5)];
        scalar_t y_k_11 = y[y_base + 11];
        scalar_t go_v_11 = grad_out[go_base + ((int64_t)11 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_3, y_k_11 * go_v_11, acc_j_0);
    }
    {
        scalar_t w_i_3 = w[w_base + ((int64_t)3 << 5)];
        scalar_t y_k_12 = y[y_base + 12];
        scalar_t go_v_12 = grad_out[go_base + ((int64_t)12 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_3, y_k_12 * go_v_12, acc_j_0);
    }
    {
        scalar_t w_i_3 = w[w_base + ((int64_t)3 << 5)];
        scalar_t y_k_13 = y[y_base + 13];
        scalar_t go_v_13 = grad_out[go_base + ((int64_t)13 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_3, y_k_13 * go_v_13, acc_j_0);
    }
    {
        scalar_t w_i_3 = w[w_base + ((int64_t)3 << 5)];
        scalar_t y_k_14 = y[y_base + 14];
        scalar_t go_v_14 = grad_out[go_base + ((int64_t)14 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_3, y_k_14 * go_v_14, acc_j_0);
    }
    {
        scalar_t w_i_3 = w[w_base + ((int64_t)3 << 5)];
        scalar_t y_k_15 = y[y_base + 15];
        scalar_t go_v_15 = grad_out[go_base + ((int64_t)15 << 5)];
        acc_j_0 = fma((scalar_t)(1.0) * w_i_3, y_k_15 * go_v_15, acc_j_0);
    }
...
template <typename scalar_t>
__launch_bounds__(32, 8) __global__ void uniform1d_split_bwd_u128_p16_grady(
    const scalar_t* __restrict__ grad_out,
    const scalar_t* __restrict__ w,
    const scalar_t* __restrict__ x_all,
...
std::vector<torch::Tensor> uniform1d_split_bwd_u128_p16(
    ...
    int64_t V)
{
    ...
    AT_DISPATCH_FLOATING_TYPES(w.scalar_type(), "uniform1d_split_bwd_u128_p16", [&] {
        uniform1d_split_bwd_u128_p16_gradw<scalar_t><<<grid, block, 0, stream>>>(
        ...
        uniform1d_split_bwd_u128_p16_gradx<scalar_t><<<grid, block, 0, stream>>>(
            grad_out.data_ptr<scalar_t>(),
            w.data_ptr<scalar_t>(),
            y.data_ptr<scalar_t>(),
        ...
        uniform1d_split_bwd_u128_p16_grady<scalar_t><<<grid, block, 0, stream>>>(
            grad_out.data_ptr<scalar_t>(),
            w.data_ptr<scalar_t>(),
            x_all.data_ptr<scalar_t>(),
...
TORCH_LIBRARY(uniform1d_split_bwd_u128_p16_codegen, m) {
    m.def("run", &uniform1d_split_bwd_u128_p16);
}
