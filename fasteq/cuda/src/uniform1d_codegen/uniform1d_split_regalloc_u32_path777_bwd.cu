...
__global__ void uniform1d_split_regalloc_u32_path777_bwd_gradw(
    ...
    int B, int Iw, int Ix, int Ky, int V)
{
    ...
    // ============================================================
    // segment 1: targets = [8, 9, 10, 11, 12, 13, 14, 15]
    // ============================================================
    {
        scalar_t acc0 = scalar_t(0);
        scalar_t acc1 = scalar_t(0);
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)20 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)21 << 5)];
            acc5 = fma((scalar_t)(1.0), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)6 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)22 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)7 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)23 << 5)];
            acc5 = fma((scalar_t)(1.0), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)24 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)25 << 5)];
            acc5 = fma((scalar_t)(1.0), xv * (yv * gov), acc5);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 3];
            scalar_t gov = grad_out[go_base + ((int64_t)16 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 3];
            scalar_t gov = grad_out[go_base + ((int64_t)17 << 5)];
            acc1 = fma((scalar_t)(1.0), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 3];
            scalar_t gov = grad_out[go_base + ((int64_t)18 << 5)];
            acc2 = fma((scalar_t)(1.0), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 3];
            scalar_t gov = grad_out[go_base + ((int64_t)19 << 5)];
            acc3 = fma((scalar_t)(1.0), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)26 << 5)];
            acc6 = fma((scalar_t)(0.54772257804870605), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)27 << 5)];
            acc7 = fma((scalar_t)(0.54772257804870605), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)30 << 5)];
            acc6 = fma((scalar_t)(0.54772257804870605), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)31 << 5)];
            acc7 = fma((scalar_t)(0.54772257804870605), xv * (yv * gov), acc7);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)28 << 5)];
            acc6 = fma((scalar_t)(0.54772257804870605), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)29 << 5)];
            acc7 = fma((scalar_t)(0.54772257804870605), xv * (yv * gov), acc7);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)26 << 5)];
            acc6 = fma((scalar_t)(-0.31622779369354248), xv * (yv * gov), acc6);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)27 << 5)];
            acc7 = fma((scalar_t)(-0.31622779369354248), xv * (yv * gov), acc7);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)28 << 5)];
            acc6 = fma((scalar_t)(0.63245558738708496), xv * (yv * gov), acc6);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)29 << 5)];
            acc7 = fma((scalar_t)(0.63245558738708496), xv * (yv * gov), acc7);
        }
        ...
        grad_w[gw_base + ((int64_t)8 << 5)] = acc0;
        grad_w[gw_base + ((int64_t)9 << 5)] = acc1;
        grad_w[gw_base + ((int64_t)10 << 5)] = acc2;
        grad_w[gw_base + ((int64_t)11 << 5)] = acc3;
        grad_w[gw_base + ((int64_t)12 << 5)] = acc4;
        grad_w[gw_base + ((int64_t)13 << 5)] = acc5;
        grad_w[gw_base + ((int64_t)14 << 5)] = acc6;
        grad_w[gw_base + ((int64_t)15 << 5)] = acc7;
    }

    // ============================================================
    // segment 2: targets = [16, 17, 18, 19, 20, 21, 22, 23]
    // ============================================================
    {
        scalar_t acc0 = scalar_t(0);
        scalar_t acc1 = scalar_t(0);
        ...
        {
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)32 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)12 << 5)];
                acc0 = fma((scalar_t)(-0.31622779369354248), xv * yg, acc0);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)14 << 5)];
                acc0 = fma((scalar_t)(-0.54772257804870605), xv * yg, acc0);
            }
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)33 << 5)];
            acc0 = fma((scalar_t)(0.54772257804870605), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)34 << 5)];
            acc0 = fma((scalar_t)(0.54772257804870605), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)43 << 5)];
            acc3 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)44 << 5)];
            acc4 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)6 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)45 << 5)];
            acc3 = fma((scalar_t)(-0.70710676908493042), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)7 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)46 << 5)];
            acc4 = fma((scalar_t)(-0.70710676908493042), xv * (yv * gov), acc4);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)33 << 5)];
            acc0 = fma((scalar_t)(0.63245558738708496), xv * (yv * gov), acc0);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)41 << 5)];
            acc3 = fma((scalar_t)(-0.70710676908493042), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)42 << 5)];
            acc4 = fma((scalar_t)(-0.70710676908493042), xv * (yv * gov), acc4);
        }
        ...
        {
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)38 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)19 << 5)];
                acc2 = fma((scalar_t)(-0.11952286213636398), xv * yg, acc2);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)21 << 5)];
                acc2 = fma((scalar_t)(-0.46291005611419678), xv * yg, acc2);
            }
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)16 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)39 << 5)];
            acc2 = fma((scalar_t)(0.37796446681022644), xv * (yv * gov), acc2);
        }

        {
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)40 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)15 << 5)];
                acc2 = fma((scalar_t)(0.46291005611419678), xv * yg, acc2);
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)47 << 5)];
            acc5 = fma((scalar_t)(0.31622776389122009), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)14 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)48 << 5)];
            acc5 = fma((scalar_t)(0.63245552778244019), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)13 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)49 << 5)];
            acc5 = fma((scalar_t)(-0.31622776389122009), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)55 << 5)];
            acc7 = fma((scalar_t)(-0.40824827551841736), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)59 << 5)];
            acc7 = fma((scalar_t)(0.40824827551841736), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)6 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)61 << 5)];
            acc7 = fma((scalar_t)(-0.81649655103683472), xv * (yv * gov), acc7);
        }

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)18 << 5)];
                acc2 = fma((scalar_t)(-0.29276999831199646), xv * yg, acc2);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)20 << 5)];
                acc2 = fma((scalar_t)(-0.37796446681022644), xv * yg, acc2);
            }
        }

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)39 << 5)];
            acc2 = fma((scalar_t)(0.47809144854545593), xv * (yv * gov), acc2);
        }
...

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)12 << 5)];
                acc5 = fma((scalar_t)(-0.54772251844406128), xv * yg, acc5);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)14 << 5)];
                acc5 = fma((scalar_t)(-0.31622776389122009), xv * yg, acc5);
            }
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)53 << 5)];
            acc7 = fma((scalar_t)(0.40824827551841736), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)57 << 5)];
            acc7 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc7);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)38 << 5)];
            acc2 = fma((scalar_t)(0.41403934359550476), xv * (yv * gov), acc2);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)39 << 5)];
            acc2 = fma((scalar_t)(0.50709253549575806), xv * (yv * gov), acc2);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)47 << 5)];
            acc5 = fma((scalar_t)(-0.54772251844406128), xv * (yv * gov), acc5);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)14 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)35 << 5)];
            acc1 = fma((scalar_t)(0.46291005611419678), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)37 << 5)];
            acc1 = fma((scalar_t)(0.46291005611419678), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)16 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)50 << 5)];
            acc6 = fma((scalar_t)(0.23145502805709839), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)21 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)51 << 5)];
            acc6 = fma((scalar_t)(0.56694668531417847), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)20 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)52 << 5)];
            acc6 = fma((scalar_t)(-0.23145502805709839), xv * (yv * gov), acc6);
        }

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)35 << 5)];
            acc1 = fma((scalar_t)(0.37796446681022644), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)36 << 5)];
            acc1 = fma((scalar_t)(0.37796446681022644), xv * (yv * gov), acc1);
        }
...

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)15 << 5)];
                acc6 = fma((scalar_t)(-0.23145502805709839), xv * yg, acc6);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)17 << 5)];
                acc6 = fma((scalar_t)(0.29880714416503906), xv * yg, acc6);
            }
        }

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)51 << 5)];
            acc6 = fma((scalar_t)(0.37796449661254883), xv * (yv * gov), acc6);
        }
...

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)12 << 5)];
                acc1 = fma((scalar_t)(0.41403934359550476), xv * yg, acc1);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)14 << 5)];
                acc1 = fma((scalar_t)(0.11952286213636398), xv * yg, acc1);
            }
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)36 << 5)];
            acc1 = fma((scalar_t)(0.47809144854545593), xv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)37 << 5)];
            acc1 = fma((scalar_t)(-0.11952286213636398), xv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)50 << 5)];
            acc6 = fma((scalar_t)(-0.29880714416503906), xv * (yv * gov), acc6);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)51 << 5)];
            acc6 = fma((scalar_t)(0.18898224830627441), xv * (yv * gov), acc6);
        }

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)18 << 5)];
                acc6 = fma((scalar_t)(-0.46291005611419678), xv * yg, acc6);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)20 << 5)];
                acc6 = fma((scalar_t)(-0.29880714416503906), xv * yg, acc6);
...

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)35 << 5)];
            acc1 = fma((scalar_t)(-0.29276999831199646), xv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)36 << 5)];
            acc1 = fma((scalar_t)(0.50709253549575806), xv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)50 << 5)];
            acc6 = fma((scalar_t)(-0.46291005611419678), xv * (yv * gov), acc6);
        }
        ...
        grad_w[gw_base + ((int64_t)16 << 5)] = acc0;
        grad_w[gw_base + ((int64_t)17 << 5)] = acc1;
        grad_w[gw_base + ((int64_t)18 << 5)] = acc2;
        grad_w[gw_base + ((int64_t)19 << 5)] = acc3;
        grad_w[gw_base + ((int64_t)20 << 5)] = acc4;
        grad_w[gw_base + ((int64_t)21 << 5)] = acc5;
        grad_w[gw_base + ((int64_t)22 << 5)] = acc6;
        grad_w[gw_base + ((int64_t)23 << 5)] = acc7;
    }

    // ============================================================
    // segment 3: targets = [24, 25, 26, 27, 28, 29, 30, 31]
    // ============================================================
    {
        scalar_t acc0 = scalar_t(0);
        scalar_t acc1 = scalar_t(0);
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)63 << 5)];
            acc1 = fma((scalar_t)(-0.40824827551841736), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)64 << 5)];
            acc1 = fma((scalar_t)(0.40824827551841736), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)13 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)65 << 5)];
            acc1 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc1);
        }

        {
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)66 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)12 << 5)];
                acc1 = fma((scalar_t)(-0.70710676908493042), xv * yg, acc1);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)14 << 5)];
                acc1 = fma((scalar_t)(0.40824827551841736), xv * yg, acc1);
            }
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)13 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)67 << 5)];
            acc1 = fma((scalar_t)(-0.40824827551841736), xv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)63 << 5)];
            acc1 = fma((scalar_t)(-0.81649655103683472), xv * (yv * gov), acc1);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)56 << 5)];
            acc0 = fma((scalar_t)(-0.40824827551841736), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)60 << 5)];
            acc0 = fma((scalar_t)(0.40824827551841736), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)7 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)62 << 5)];
            acc0 = fma((scalar_t)(-0.81649655103683472), xv * (yv * gov), acc0);
        }

        {
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)74 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)15 << 5)];
                acc3 = fma((scalar_t)(0.42257711291313171), xv * yg, acc3);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)17 << 5)];
                acc3 = fma((scalar_t)(0.32732683420181274), xv * yg, acc3);
            }
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)20 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)75 << 5)];
            acc3 = fma((scalar_t)(0.59761428833007812), xv * (yv * gov), acc3);
        }

        {
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)76 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)19 << 5)];
                acc3 = fma((scalar_t)(-0.32732683420181274), xv * yg, acc3);
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)18 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)77 << 5)];
            acc3 = fma((scalar_t)(0.26726123690605164), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)78 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)79 << 5)];
            acc5 = fma((scalar_t)(1.0), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)80 << 5)];
            acc6 = fma((scalar_t)(1.0), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)81 << 5)];
            acc7 = fma((scalar_t)(1.0), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)54 << 5)];
            acc0 = fma((scalar_t)(0.40824827551841736), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)58 << 5)];
            acc0 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)73 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)15 << 5)];
                acc3 = fma((scalar_t)(-0.42257711291313171), xv * yg, acc3);
...

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)75 << 5)];
            acc3 = fma((scalar_t)(0.37796446681022644), xv * (yv * gov), acc3);
        }

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)76 << 5)];
            acc3 = fma((scalar_t)(-0.53452247381210327), xv * (yv * gov), acc3);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)82 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)83 << 5)];
            acc5 = fma((scalar_t)(1.0), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)84 << 5)];
            acc6 = fma((scalar_t)(1.0), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)85 << 5)];
            acc7 = fma((scalar_t)(1.0), xv * (yv * gov), acc7);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)86 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)87 << 5)];
            acc5 = fma((scalar_t)(1.0), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)88 << 5)];
            acc6 = fma((scalar_t)(1.0), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)89 << 5)];
            acc7 = fma((scalar_t)(1.0), xv * (yv * gov), acc7);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 7];
            scalar_t gov = grad_out[go_base + ((int64_t)90 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 7];
            scalar_t gov = grad_out[go_base + ((int64_t)91 << 5)];
            acc5 = fma((scalar_t)(1.0), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 7];
            scalar_t gov = grad_out[go_base + ((int64_t)92 << 5)];
            acc6 = fma((scalar_t)(1.0), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 7];
            scalar_t gov = grad_out[go_base + ((int64_t)93 << 5)];
            acc7 = fma((scalar_t)(1.0), xv * (yv * gov), acc7);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 8];
            scalar_t gov = grad_out[go_base + ((int64_t)94 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 8];
            scalar_t gov = grad_out[go_base + ((int64_t)95 << 5)];
            acc5 = fma((scalar_t)(1.0), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 8];
            scalar_t gov = grad_out[go_base + ((int64_t)96 << 5)];
            acc6 = fma((scalar_t)(1.0), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 8];
            scalar_t gov = grad_out[go_base + ((int64_t)97 << 5)];
            acc7 = fma((scalar_t)(1.0), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)68 << 5)];
            acc2 = fma((scalar_t)(0.42257711291313171), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)69 << 5)];
            acc2 = fma((scalar_t)(-0.42257711291313171), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)14 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)71 << 5)];
            acc2 = fma((scalar_t)(0.42257711291313171), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)13 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)72 << 5)];
            acc2 = fma((scalar_t)(-0.42257711291313171), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)14 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)70 << 5)];
            acc2 = fma((scalar_t)(0.59761428833007812), xv * (yv * gov), acc2);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)68 << 5)];
            acc2 = fma((scalar_t)(0.32732683420181274), xv * (yv * gov), acc2);
        }
...

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)14 << 5)];
                acc2 = fma((scalar_t)(-0.32732683420181274), xv * yg, acc2);
            }
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)68 << 5)];
            acc2 = fma((scalar_t)(0.26726123690605164), xv * (yv * gov), acc2);
        }

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)69 << 5)];
            acc2 = fma((scalar_t)(-0.53452247381210327), xv * (yv * gov), acc2);
        }
        ...
        grad_w[gw_base + ((int64_t)24 << 5)] = acc0;
        grad_w[gw_base + ((int64_t)25 << 5)] = acc1;
        grad_w[gw_base + ((int64_t)26 << 5)] = acc2;
        grad_w[gw_base + ((int64_t)27 << 5)] = acc3;
        grad_w[gw_base + ((int64_t)28 << 5)] = acc4;
        grad_w[gw_base + ((int64_t)29 << 5)] = acc5;
        grad_w[gw_base + ((int64_t)30 << 5)] = acc6;
        grad_w[gw_base + ((int64_t)31 << 5)] = acc7;
    }

    // ============================================================
    // segment 4: targets = [32, 33, 34, 35, 36, 37, 38, 39]
    // ============================================================
    {
        scalar_t acc0 = scalar_t(0);
        scalar_t acc1 = scalar_t(0);
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)118 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)119 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)12 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)120 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)13 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)121 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)14 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)122 << 5)];
            acc4 = fma((scalar_t)(1.0), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)98 << 5)];
            acc0 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)99 << 5)];
            acc1 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)6 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)100 << 5)];
            acc0 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)7 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)101 << 5)];
            acc1 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)102 << 5)];
            acc0 = fma((scalar_t)(-0.40824827551841736), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)103 << 5)];
            acc1 = fma((scalar_t)(-0.40824827551841736), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)106 << 5)];
            acc0 = fma((scalar_t)(-0.70710676908493042), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)107 << 5)];
            acc1 = fma((scalar_t)(-0.70710676908493042), xv * (yv * gov), acc1);
        }

        {
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)128 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)19 << 5)];
                acc6 = fma((scalar_t)(-0.15430335700511932), xv * yg, acc6);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)21 << 5)];
                acc6 = fma((scalar_t)(-0.59761428833007812), xv * yg, acc6);
            }
        }

        {
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)129 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)18 << 5)];
                acc6 = fma((scalar_t)(-0.37796446681022644), xv * yg, acc6);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)20 << 5)];
                acc6 = fma((scalar_t)(-0.48795005679130554), xv * yg, acc6);
            }
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)17 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)130 << 5)];
            acc6 = fma((scalar_t)(0.53452247381210327), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)16 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)131 << 5)];
            acc6 = fma((scalar_t)(0.48795005679130554), xv * (yv * gov), acc6);
        }

        {
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)132 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)15 << 5)];
                acc6 = fma((scalar_t)(0.59761428833007812), xv * yg, acc6);
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)104 << 5)];
            acc0 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)105 << 5)];
            acc1 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)129 << 5)];
            acc6 = fma((scalar_t)(0.61721342802047729), xv * (yv * gov), acc6);
        }

        {
            ...
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)130 << 5)];
            acc6 = fma((scalar_t)(0.65465366840362549), xv * (yv * gov), acc6);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)12 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)123 << 5)];
            acc5 = fma((scalar_t)(-0.53452247381210327), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)13 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)124 << 5)];
            acc5 = fma((scalar_t)(0.46291005611419678), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)125 << 5)];
            acc5 = fma((scalar_t)(-0.53452247381210327), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)126 << 5)];
            acc5 = fma((scalar_t)(0.46291005611419678), xv * (yv * gov), acc5);
        }
...

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)12 << 5)];
                acc5 = fma((scalar_t)(0.26726123690605164), xv * yg, acc5);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)14 << 5)];
                acc5 = fma((scalar_t)(-0.46291005611419678), xv * yg, acc5);
            }
        }

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)125 << 5)];
            acc5 = fma((scalar_t)(0.26726123690605164), xv * (yv * gov), acc5);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)127 << 5)];
            acc5 = fma((scalar_t)(-0.46291005611419678), xv * (yv * gov), acc5);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)108 << 5)];
            acc2 = fma((scalar_t)(0.59761428833007812), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)109 << 5)];
            acc3 = fma((scalar_t)(0.59761428833007812), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)116 << 5)];
            acc2 = fma((scalar_t)(0.59761428833007812), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)117 << 5)];
            acc3 = fma((scalar_t)(0.59761428833007812), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)19 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)133 << 5)];
            acc7 = fma((scalar_t)(-0.24397502839565277), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)20 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)134 << 5)];
            acc7 = fma((scalar_t)(0.38575837016105652), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)15 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)135 << 5)];
            acc7 = fma((scalar_t)(-0.54554474353790283), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)16 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)136 << 5)];
            acc7 = fma((scalar_t)(0.38575837016105652), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)17 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)137 << 5)];
            acc7 = fma((scalar_t)(-0.24397502839565277), xv * (yv * gov), acc7);
        }

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)108 << 5)];
            acc2 = fma((scalar_t)(0.48795005679130554), xv * (yv * gov), acc2);
        }

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)109 << 5)];
            acc3 = fma((scalar_t)(0.48795005679130554), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)110 << 5)];
            acc2 = fma((scalar_t)(0.48795005679130554), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)111 << 5)];
            acc3 = fma((scalar_t)(0.48795005679130554), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)114 << 5)];
            acc2 = fma((scalar_t)(0.48795005679130554), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)115 << 5)];
            acc3 = fma((scalar_t)(0.48795005679130554), xv * (yv * gov), acc3);
        }

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)133 << 5)];
            acc7 = fma((scalar_t)(-0.48795005679130554), xv * (yv * gov), acc7);
        }

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)19 << 5)];
                acc7 = fma((scalar_t)(0.29880714416503906), xv * yg, acc7);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)21 << 5)];
                acc7 = fma((scalar_t)(-0.38575837016105652), xv * yg, acc7);
            }
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)108 << 5)];
            acc2 = fma((scalar_t)(-0.15430335700511932), xv * (yv * gov), acc2);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)109 << 5)];
            acc3 = fma((scalar_t)(-0.15430335700511932), xv * (yv * gov), acc3);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)110 << 5)];
            acc2 = fma((scalar_t)(0.61721342802047729), xv * (yv * gov), acc2);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)111 << 5)];
            acc3 = fma((scalar_t)(0.61721342802047729), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)112 << 5)];
            acc2 = fma((scalar_t)(0.53452247381210327), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)113 << 5)];
            acc3 = fma((scalar_t)(0.53452247381210327), xv * (yv * gov), acc3);
        }
...

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)19 << 5)];
                acc7 = fma((scalar_t)(0.37796446681022644), xv * yg, acc7);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)21 << 5)];
                acc7 = fma((scalar_t)(0.24397502839565277), xv * yg, acc7);
            }
        }

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)18 << 5)];
                acc7 = fma((scalar_t)(0.15430335700511932), xv * yg, acc7);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)20 << 5)];
                acc7 = fma((scalar_t)(-0.29880714416503906), xv * yg, acc7);
...

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)135 << 5)];
            acc7 = fma((scalar_t)(0.32732683420181274), xv * (yv * gov), acc7);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)136 << 5)];
            acc7 = fma((scalar_t)(0.29880714416503906), xv * (yv * gov), acc7);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)112 << 5)];
            acc2 = fma((scalar_t)(0.65465366840362549), xv * (yv * gov), acc2);
        }

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)113 << 5)];
            acc3 = fma((scalar_t)(0.65465366840362549), xv * (yv * gov), acc3);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)134 << 5)];
            acc7 = fma((scalar_t)(0.15430335700511932), xv * (yv * gov), acc7);
        }

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)135 << 5)];
            acc7 = fma((scalar_t)(0.43643578886985779), xv * (yv * gov), acc7);
        }
        ...
        grad_w[gw_base + ((int64_t)32 << 5)] = acc0;
        grad_w[gw_base + ((int64_t)33 << 5)] = acc1;
        grad_w[gw_base + ((int64_t)34 << 5)] = acc2;
        grad_w[gw_base + ((int64_t)35 << 5)] = acc3;
        grad_w[gw_base + ((int64_t)36 << 5)] = acc4;
        grad_w[gw_base + ((int64_t)37 << 5)] = acc5;
        grad_w[gw_base + ((int64_t)38 << 5)] = acc6;
        grad_w[gw_base + ((int64_t)39 << 5)] = acc7;
    }

    // ============================================================
    // segment 5: targets = [40, 41, 42, 43, 44, 45, 46, 47]
    // ============================================================
    {
        scalar_t acc0 = scalar_t(0);
        scalar_t acc1 = scalar_t(0);
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)14 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)180 << 5)];
            acc6 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)13 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)181 << 5)];
            acc6 = fma((scalar_t)(0.57735025882720947), xv * (yv * gov), acc6);
        }

        {
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)182 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)12 << 5)];
                acc6 = fma((scalar_t)(0.63245552778244019), xv * yg, acc6);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)14 << 5)];
                acc6 = fma((scalar_t)(0.18257418274879456), xv * yg, acc6);
            }
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)183 << 5)];
            acc6 = fma((scalar_t)(-0.4472135603427887), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)184 << 5)];
            acc6 = fma((scalar_t)(-0.18257418274879456), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)185 << 5)];
            acc6 = fma((scalar_t)(-0.57735025882720947), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)186 << 5)];
            acc6 = fma((scalar_t)(-0.70710676908493042), xv * (yv * gov), acc6);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)182 << 5)];
            acc6 = fma((scalar_t)(0.73029673099517822), xv * (yv * gov), acc6);
        }

        {
            ...
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)183 << 5)];
            acc6 = fma((scalar_t)(0.7745966911315918), xv * (yv * gov), acc6);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)166 << 5)];
            acc4 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)167 << 5)];
            acc5 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)6 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)168 << 5)];
            acc4 = fma((scalar_t)(0.57735025882720947), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)7 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)169 << 5)];
            acc5 = fma((scalar_t)(0.57735025882720947), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)170 << 5)];
            acc4 = fma((scalar_t)(-0.18257418274879456), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)171 << 5)];
            acc5 = fma((scalar_t)(-0.18257418274879456), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)174 << 5)];
            acc4 = fma((scalar_t)(-0.18257418274879456), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)175 << 5)];
            acc5 = fma((scalar_t)(-0.18257418274879456), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)178 << 5)];
            acc4 = fma((scalar_t)(-0.70710676908493042), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)179 << 5)];
            acc5 = fma((scalar_t)(-0.70710676908493042), xv * (yv * gov), acc5);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)170 << 5)];
            acc4 = fma((scalar_t)(0.73029673099517822), xv * (yv * gov), acc4);
        }

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)171 << 5)];
            acc5 = fma((scalar_t)(0.73029673099517822), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)172 << 5)];
            acc4 = fma((scalar_t)(-0.4472135603427887), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)173 << 5)];
            acc5 = fma((scalar_t)(-0.4472135603427887), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)176 << 5)];
            acc4 = fma((scalar_t)(-0.57735025882720947), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)177 << 5)];
            acc5 = fma((scalar_t)(-0.57735025882720947), xv * (yv * gov), acc5);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)170 << 5)];
            acc4 = fma((scalar_t)(0.63245552778244019), xv * (yv * gov), acc4);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)172 << 5)];
            acc4 = fma((scalar_t)(0.7745966911315918), xv * (yv * gov), acc4);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)173 << 5)];
            acc5 = fma((scalar_t)(0.7745966911315918), xv * (yv * gov), acc5);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)138 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)139 << 5)];
            acc1 = fma((scalar_t)(1.0), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)140 << 5)];
            acc2 = fma((scalar_t)(1.0), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)141 << 5)];
            acc3 = fma((scalar_t)(1.0), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)12 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)187 << 5)];
            acc7 = fma((scalar_t)(-0.64549720287322998), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)13 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)188 << 5)];
            acc7 = fma((scalar_t)(0.4564354419708252), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)14 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)189 << 5)];
            acc7 = fma((scalar_t)(-0.28867512941360474), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)191 << 5)];
            acc7 = fma((scalar_t)(-0.28867512941360474), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)192 << 5)];
            acc7 = fma((scalar_t)(0.4564354419708252), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)142 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)143 << 5)];
            acc1 = fma((scalar_t)(1.0), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)144 << 5)];
            acc2 = fma((scalar_t)(1.0), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)145 << 5)];
            acc3 = fma((scalar_t)(1.0), xv * (yv * gov), acc3);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)189 << 5)];
            acc7 = fma((scalar_t)(0.35355338454246521), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)190 << 5)];
            acc7 = fma((scalar_t)(-0.57735025882720947), xv * (yv * gov), acc7);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)193 << 5)];
            acc7 = fma((scalar_t)(-0.4564354419708252), xv * (yv * gov), acc7);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)146 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)147 << 5)];
            acc1 = fma((scalar_t)(1.0), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)148 << 5)];
            acc2 = fma((scalar_t)(1.0), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)149 << 5)];
            acc3 = fma((scalar_t)(1.0), xv * (yv * gov), acc3);
        }
...

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)12 << 5)];
                acc7 = fma((scalar_t)(0.3872983455657959), xv * yg, acc7);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)14 << 5)];
                acc7 = fma((scalar_t)(-0.4472135603427887), xv * yg, acc7);
            }
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)190 << 5)];
            acc7 = fma((scalar_t)(0.18257418274879456), xv * (yv * gov), acc7);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)191 << 5)];
            acc7 = fma((scalar_t)(0.4472135603427887), xv * (yv * gov), acc7);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)150 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)151 << 5)];
            acc1 = fma((scalar_t)(1.0), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)152 << 5)];
            acc2 = fma((scalar_t)(1.0), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)153 << 5)];
            acc3 = fma((scalar_t)(1.0), xv * (yv * gov), acc3);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)190 << 5)];
            acc7 = fma((scalar_t)(0.51639777421951294), xv * (yv * gov), acc7);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 13];
            scalar_t gov = grad_out[go_base + ((int64_t)154 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 13];
            scalar_t gov = grad_out[go_base + ((int64_t)155 << 5)];
            acc1 = fma((scalar_t)(1.0), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 13];
            scalar_t gov = grad_out[go_base + ((int64_t)156 << 5)];
            acc2 = fma((scalar_t)(1.0), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 13];
            scalar_t gov = grad_out[go_base + ((int64_t)157 << 5)];
            acc3 = fma((scalar_t)(1.0), xv * (yv * gov), acc3);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 14];
            scalar_t gov = grad_out[go_base + ((int64_t)158 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 14];
            scalar_t gov = grad_out[go_base + ((int64_t)159 << 5)];
            acc1 = fma((scalar_t)(1.0), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 14];
            scalar_t gov = grad_out[go_base + ((int64_t)160 << 5)];
            acc2 = fma((scalar_t)(1.0), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 14];
            scalar_t gov = grad_out[go_base + ((int64_t)161 << 5)];
            acc3 = fma((scalar_t)(1.0), xv * (yv * gov), acc3);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)0 << 5)];
            scalar_t yv  = y[y_base + 15];
            scalar_t gov = grad_out[go_base + ((int64_t)162 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)1 << 5)];
            scalar_t yv  = y[y_base + 15];
            scalar_t gov = grad_out[go_base + ((int64_t)163 << 5)];
            acc1 = fma((scalar_t)(1.0), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)2 << 5)];
            scalar_t yv  = y[y_base + 15];
            scalar_t gov = grad_out[go_base + ((int64_t)164 << 5)];
            acc2 = fma((scalar_t)(1.0), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)3 << 5)];
            scalar_t yv  = y[y_base + 15];
            scalar_t gov = grad_out[go_base + ((int64_t)165 << 5)];
            acc3 = fma((scalar_t)(1.0), xv * (yv * gov), acc3);
        }
        ...
        grad_w[gw_base + ((int64_t)40 << 5)] = acc0;
        grad_w[gw_base + ((int64_t)41 << 5)] = acc1;
        grad_w[gw_base + ((int64_t)42 << 5)] = acc2;
        grad_w[gw_base + ((int64_t)43 << 5)] = acc3;
        grad_w[gw_base + ((int64_t)44 << 5)] = acc4;
        grad_w[gw_base + ((int64_t)45 << 5)] = acc5;
        grad_w[gw_base + ((int64_t)46 << 5)] = acc6;
        grad_w[gw_base + ((int64_t)47 << 5)] = acc7;
    }

    // ============================================================
    // segment 6: targets = [48, 49, 50, 51, 52, 53, 54]
    // ============================================================
    {
        scalar_t acc0 = scalar_t(0);
        scalar_t acc1 = scalar_t(0);
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)15 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)194 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)16 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)195 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)17 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)196 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)18 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)197 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)19 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)198 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)20 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)199 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)21 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)200 << 5)];
            acc0 = fma((scalar_t)(1.0), xv * (yv * gov), acc0);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)16 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)229 << 5)];
            acc5 = fma((scalar_t)(-0.35355338454246521), xv * (yv * gov), acc5);
        }

        {
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)230 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)15 << 5)];
                acc5 = fma((scalar_t)(0.35355338454246521), xv * yg, acc5);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)17 << 5)];
                acc5 = fma((scalar_t)(-0.4564354419708252), xv * yg, acc5);
            }
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)16 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)231 << 5)];
            acc5 = fma((scalar_t)(0.4564354419708252), xv * (yv * gov), acc5);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)19 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)232 << 5)];
            acc5 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc5);
        }

        {
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)233 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)18 << 5)];
                acc5 = fma((scalar_t)(-0.70710676908493042), xv * yg, acc5);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)20 << 5)];
                acc5 = fma((scalar_t)(0.4564354419708252), xv * yg, acc5);
        ...
        {
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)234 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)19 << 5)];
                acc5 = fma((scalar_t)(-0.4564354419708252), xv * yg, acc5);
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)20 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)235 << 5)];
            acc5 = fma((scalar_t)(-0.35355338454246521), xv * (yv * gov), acc5);
        }

        {
            ...
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)229 << 5)];
            acc5 = fma((scalar_t)(-0.86602538824081421), xv * (yv * gov), acc5);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)231 << 5)];
            acc5 = fma((scalar_t)(-0.28867512941360474), xv * (yv * gov), acc5);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)19 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)201 << 5)];
            acc1 = fma((scalar_t)(-0.28867512941360474), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)18 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)202 << 5)];
            acc1 = fma((scalar_t)(-0.57735025882720947), xv * (yv * gov), acc1);
        }

        {
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)203 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)19 << 5)];
                acc1 = fma((scalar_t)(0.4472135603427887), xv * yg, acc1);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)21 << 5)];
                acc1 = fma((scalar_t)(0.28867512941360474), xv * yg, acc1);
            }
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)16 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)204 << 5)];
            acc1 = fma((scalar_t)(-0.57735025882720947), xv * (yv * gov), acc1);
        }

        {
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)205 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)15 << 5)];
                acc1 = fma((scalar_t)(-0.28867512941360474), xv * yg, acc1);
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)17 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)207 << 5)];
            acc1 = fma((scalar_t)(0.28867512941360474), xv * (yv * gov), acc1);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)222 << 5)];
            acc4 = fma((scalar_t)(-0.49999997019767761), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)224 << 5)];
            acc4 = fma((scalar_t)(-0.3872983455657959), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)14 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)225 << 5)];
            acc4 = fma((scalar_t)(-0.31622776389122009), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)13 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)226 << 5)];
            acc4 = fma((scalar_t)(0.3872983455657959), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)12 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)227 << 5)];
            acc4 = fma((scalar_t)(-0.70710676908493042), xv * (yv * gov), acc4);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)13 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)228 << 5)];
            acc4 = fma((scalar_t)(-0.49999997019767761), xv * (yv * gov), acc4);
        }

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)201 << 5)];
            acc1 = fma((scalar_t)(0.4564354419708252), xv * (yv * gov), acc1);
        }

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)19 << 5)];
                acc1 = fma((scalar_t)(0.35355338454246521), xv * yg, acc1);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)21 << 5)];
                acc1 = fma((scalar_t)(-0.4564354419708252), xv * yg, acc1);
            }
        }

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)18 << 5)];
                acc1 = fma((scalar_t)(0.18257418274879456), xv * yg, acc1);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)20 << 5)];
                acc1 = fma((scalar_t)(-0.35355338454246521), xv * yg, acc1);
...

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)204 << 5)];
            acc1 = fma((scalar_t)(0.18257418274879456), xv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)205 << 5)];
            acc1 = fma((scalar_t)(0.35355338454246521), xv * (yv * gov), acc1);
        }

        {
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)206 << 5)];
            scalar_t yg  = yv * gov;
            {
                scalar_t xv = x_all[x_base + ((int64_t)15 << 5)];
                acc1 = fma((scalar_t)(0.4564354419708252), xv * yg, acc1);
...

        {
            ...
            {
                scalar_t xv = x_all[x_base + ((int64_t)12 << 5)];
                acc4 = fma((scalar_t)(-0.4472135603427887), xv * yg, acc4);
            }
            {
                scalar_t xv = x_all[x_base + ((int64_t)14 << 5)];
                acc4 = fma((scalar_t)(0.3872983455657959), xv * yg, acc4);
            }
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)201 << 5)];
            acc1 = fma((scalar_t)(-0.64549720287322998), xv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)203 << 5)];
            acc1 = fma((scalar_t)(0.3872983455657959), xv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)204 << 5)];
            acc1 = fma((scalar_t)(0.51639777421951294), xv * (yv * gov), acc1);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)14 << 5)];
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)223 << 5)];
            acc4 = fma((scalar_t)(-0.70710676908493042), xv * (yv * gov), acc4);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)210 << 5)];
            acc2 = fma((scalar_t)(-0.35355338454246521), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)211 << 5)];
            acc3 = fma((scalar_t)(-0.35355338454246521), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)218 << 5)];
            acc2 = fma((scalar_t)(0.35355338454246521), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)219 << 5)];
            acc3 = fma((scalar_t)(0.35355338454246521), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)6 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)220 << 5)];
            acc2 = fma((scalar_t)(-0.86602538824081421), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)7 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)221 << 5)];
            acc3 = fma((scalar_t)(-0.86602538824081421), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)17 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)237 << 5)];
            acc6 = fma((scalar_t)(0.40824830532073975), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)16 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)238 << 5)];
            acc6 = fma((scalar_t)(-0.40824830532073975), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)21 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)239 << 5)];
            acc6 = fma((scalar_t)(-0.40824830532073975), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)20 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)240 << 5)];
            acc6 = fma((scalar_t)(0.40824830532073975), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)19 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)241 << 5)];
            acc6 = fma((scalar_t)(-0.40824830532073975), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)18 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)242 << 5)];
            acc6 = fma((scalar_t)(0.40824830532073975), xv * (yv * gov), acc6);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)208 << 5)];
            acc2 = fma((scalar_t)(0.35355338454246521), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)209 << 5)];
            acc3 = fma((scalar_t)(0.35355338454246521), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)4 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)212 << 5)];
            acc2 = fma((scalar_t)(-0.4564354419708252), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)5 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)213 << 5)];
            acc3 = fma((scalar_t)(-0.4564354419708252), xv * (yv * gov), acc3);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)216 << 5)];
            acc2 = fma((scalar_t)(0.4564354419708252), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)217 << 5)];
            acc3 = fma((scalar_t)(0.4564354419708252), xv * (yv * gov), acc3);
        }

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)218 << 5)];
            acc2 = fma((scalar_t)(-0.57735025882720947), xv * (yv * gov), acc2);
        }

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)219 << 5)];
            acc3 = fma((scalar_t)(-0.57735025882720947), xv * (yv * gov), acc3);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)17 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)236 << 5)];
            acc6 = fma((scalar_t)(-0.40824830532073975), xv * (yv * gov), acc6);
        }
...

        {
            scalar_t xv  = x_all[x_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)214 << 5)];
            acc2 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc2);
        }

        {
            scalar_t xv  = x_all[x_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)215 << 5)];
            acc3 = fma((scalar_t)(0.70710676908493042), xv * (yv * gov), acc3);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)216 << 5)];
            acc2 = fma((scalar_t)(-0.28867512941360474), xv * (yv * gov), acc2);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)217 << 5)];
            acc3 = fma((scalar_t)(-0.28867512941360474), xv * (yv * gov), acc3);
        }
        ...
        grad_w[gw_base + ((int64_t)48 << 5)] = acc0;
        grad_w[gw_base + ((int64_t)49 << 5)] = acc1;
        grad_w[gw_base + ((int64_t)50 << 5)] = acc2;
        grad_w[gw_base + ((int64_t)51 << 5)] = acc3;
        grad_w[gw_base + ((int64_t)52 << 5)] = acc4;
        grad_w[gw_base + ((int64_t)53 << 5)] = acc5;
        grad_w[gw_base + ((int64_t)54 << 5)] = acc6;
    }
...
template <typename scalar_t>
__global__ void uniform1d_split_regalloc_u32_path777_bwd_gradx(
    const scalar_t* __restrict__ grad_out,
    ...
    int B, int Iw, int Ix, int Ky, int V)
{
    ...
    // ============================================================
    {
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)8 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)8 << 5)];
            acc0 = fma((scalar_t)(1.0), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)9 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)9 << 5)];
            acc1 = fma((scalar_t)(1.0), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)28 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)78 << 5)];
            acc0 = fma((scalar_t)(1.0), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)29 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)79 << 5)];
            acc1 = fma((scalar_t)(1.0), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)40 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)138 << 5)];
            acc0 = fma((scalar_t)(1.0), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)41 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)139 << 5)];
            acc1 = fma((scalar_t)(1.0), wv * (yv * gov), acc1);
        }
    ...
    // ============================================================
    {
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)10 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)10 << 5)];
            acc0 = fma((scalar_t)(1.0), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)11 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)11 << 5)];
            acc1 = fma((scalar_t)(1.0), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)30 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)80 << 5)];
            acc0 = fma((scalar_t)(1.0), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)31 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)81 << 5)];
            acc1 = fma((scalar_t)(1.0), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)42 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)140 << 5)];
            acc0 = fma((scalar_t)(1.0), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)43 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)141 << 5)];
            acc1 = fma((scalar_t)(1.0), wv * (yv * gov), acc1);
        }
    ...
    // ============================================================
    {
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)12 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)20 << 5)];
            acc0 = fma((scalar_t)(1.0), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)13 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)21 << 5)];
            acc1 = fma((scalar_t)(1.0), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)14 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)30 << 5)];
            acc0 = fma((scalar_t)(0.54772257804870605), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)26 << 5)];
            acc0 = fma((scalar_t)(-0.31622779369354248), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)15 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)31 << 5)];
            acc1 = fma((scalar_t)(0.54772257804870605), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)27 << 5)];
            acc1 = fma((scalar_t)(-0.31622779369354248), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)19 << 5)];
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)45 << 5)];
            acc0 = fma((scalar_t)(0.70710676908493042), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)20 << 5)];
            scalar_t yv  = y[y_base + 2];
            scalar_t gov = grad_out[go_base + ((int64_t)46 << 5)];
            acc1 = fma((scalar_t)(0.70710676908493042), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)23 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)55 << 5)];
            acc0 = fma((scalar_t)(-0.40824827551841736), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)24 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)56 << 5)];
            acc1 = fma((scalar_t)(-0.40824827551841736), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)32 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)102 << 5)];
            acc0 = fma((scalar_t)(-0.40824827551841736), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)33 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)103 << 5)];
            acc1 = fma((scalar_t)(-0.40824827551841736), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)34 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)116 << 5)];
            acc0 = fma((scalar_t)(0.59761428833007812), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)114 << 5)];
            acc0 = fma((scalar_t)(0.48795005679130554), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)112 << 5)];
            acc0 = fma((scalar_t)(0.53452247381210327), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)116 << 5)];
            acc0 = fma((scalar_t)(0.15430335700511932), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)35 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)117 << 5)];
            acc1 = fma((scalar_t)(0.59761428833007812), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)115 << 5)];
            acc1 = fma((scalar_t)(0.48795005679130554), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)113 << 5)];
            acc1 = fma((scalar_t)(0.53452247381210327), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)117 << 5)];
            acc1 = fma((scalar_t)(0.15430335700511932), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)44 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)174 << 5)];
            acc0 = fma((scalar_t)(-0.18257418274879456), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)172 << 5)];
            acc0 = fma((scalar_t)(-0.4472135603427887), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)170 << 5)];
            acc0 = fma((scalar_t)(0.63245552778244019), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)45 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)175 << 5)];
            acc1 = fma((scalar_t)(-0.18257418274879456), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)173 << 5)];
            acc1 = fma((scalar_t)(-0.4472135603427887), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)171 << 5)];
            acc1 = fma((scalar_t)(0.63245552778244019), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)50 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)210 << 5)];
            acc0 = fma((scalar_t)(-0.35355338454246521), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)212 << 5)];
            acc0 = fma((scalar_t)(-0.4564354419708252), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)51 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)211 << 5)];
            acc1 = fma((scalar_t)(-0.35355338454246521), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)213 << 5)];
            acc1 = fma((scalar_t)(-0.4564354419708252), wv * (yv * gov), acc1);
        }
    ...
    // ============================================================
    {
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)28 << 5)];
            acc0 = fma((scalar_t)(0.63245558738708496), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)29 << 5)];
            acc1 = fma((scalar_t)(0.63245558738708496), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)61 << 5)];
            acc0 = fma((scalar_t)(-0.81649655103683472), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)62 << 5)];
            acc1 = fma((scalar_t)(-0.81649655103683472), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)110 << 5)];
            acc0 = fma((scalar_t)(0.61721342802047729), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)112 << 5)];
            acc0 = fma((scalar_t)(0.65465366840362549), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)111 << 5)];
            acc1 = fma((scalar_t)(0.61721342802047729), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)113 << 5)];
            acc1 = fma((scalar_t)(0.65465366840362549), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)170 << 5)];
            acc0 = fma((scalar_t)(0.73029673099517822), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)172 << 5)];
            acc0 = fma((scalar_t)(0.7745966911315918), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)171 << 5)];
            acc1 = fma((scalar_t)(0.73029673099517822), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)173 << 5)];
            acc1 = fma((scalar_t)(0.7745966911315918), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)220 << 5)];
            acc0 = fma((scalar_t)(-0.86602538824081421), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)216 << 5)];
            acc0 = fma((scalar_t)(-0.28867512941360474), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)221 << 5)];
            acc1 = fma((scalar_t)(-0.86602538824081421), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)217 << 5)];
            acc1 = fma((scalar_t)(-0.28867512941360474), wv * (yv * gov), acc1);
        }
    ...
    // ============================================================
    {
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)16 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)33 << 5)];
            acc1 = fma((scalar_t)(0.54772257804870605), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)17 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)37 << 5)];
            acc0 = fma((scalar_t)(0.46291005611419678), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)36 << 5)];
            acc1 = fma((scalar_t)(0.47809144854545593), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)37 << 5)];
            acc0 = fma((scalar_t)(-0.11952286213636398), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)35 << 5)];
            acc1 = fma((scalar_t)(-0.29276999831199646), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)21 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)47 << 5)];
            acc1 = fma((scalar_t)(0.31622776389122009), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)47 << 5)];
            acc0 = fma((scalar_t)(-0.31622776389122009), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)49 << 5)];
            acc1 = fma((scalar_t)(0.54772251844406128), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)25 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)63 << 5)];
            acc1 = fma((scalar_t)(-0.40824827551841736), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)26 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)68 << 5)];
            acc1 = fma((scalar_t)(0.42257711291313171), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)69 << 5)];
            acc0 = fma((scalar_t)(-0.42257711291313171), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)68 << 5)];
            acc1 = fma((scalar_t)(0.32732683420181274), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)69 << 5)];
            acc0 = fma((scalar_t)(-0.32732683420181274), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)72 << 5)];
            acc0 = fma((scalar_t)(-0.26726123690605164), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)36 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)118 << 5)];
            acc0 = fma((scalar_t)(1.0), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)37 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)125 << 5)];
            acc0 = fma((scalar_t)(-0.53452247381210327), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)126 << 5)];
            acc1 = fma((scalar_t)(0.46291005611419678), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)125 << 5)];
            acc1 = fma((scalar_t)(0.26726123690605164), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)46 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)183 << 5)];
            acc1 = fma((scalar_t)(-0.4472135603427887), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)47 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)191 << 5)];
            acc0 = fma((scalar_t)(-0.28867512941360474), wv * (yv * gov), acc0);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)52 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)222 << 5)];
            acc1 = fma((scalar_t)(-0.49999997019767761), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)224 << 5)];
            acc1 = fma((scalar_t)(-0.3872983455657959), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)222 << 5)];
            acc0 = fma((scalar_t)(0.49999997019767761), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)224 << 5)];
            acc0 = fma((scalar_t)(0.3872983455657959), wv * (yv * gov), acc0);
        }
    ...
    // ============================================================
    {
...

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)35 << 5)];
            acc0 = fma((scalar_t)(0.41403934359550476), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)36 << 5)];
            acc0 = fma((scalar_t)(0.50709253549575806), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)49 << 5)];
            acc0 = fma((scalar_t)(-0.54772251844406128), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)187 << 5)];
            acc0 = fma((scalar_t)(-0.64549720287322998), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)190 << 5)];
            acc0 = fma((scalar_t)(0.51639777421951294), wv * (yv * gov), acc0);
        }
    ...
    // ============================================================
    {
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)18 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)40 << 5)];
            acc1 = fma((scalar_t)(0.46291005611419678), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)22 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)50 << 5)];
            acc1 = fma((scalar_t)(-0.23145502805709839), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 15];
            scalar_t gov = grad_out[go_base + ((int64_t)51 << 5)];
            acc1 = fma((scalar_t)(-0.56694668531417847), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)27 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)74 << 5)];
            acc1 = fma((scalar_t)(0.42257711291313171), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)38 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)132 << 5)];
            acc1 = fma((scalar_t)(0.59761428833007812), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)39 << 5)];
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)135 << 5)];
            acc1 = fma((scalar_t)(-0.54554474353790283), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)136 << 5)];
            acc1 = fma((scalar_t)(0.38575837016105652), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)137 << 5)];
            acc1 = fma((scalar_t)(-0.24397502839565277), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)48 << 5)];
            scalar_t yv  = y[y_base + 0];
            scalar_t gov = grad_out[go_base + ((int64_t)194 << 5)];
            acc1 = fma((scalar_t)(1.0), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)49 << 5)];
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)205 << 5)];
            acc1 = fma((scalar_t)(-0.28867512941360474), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)201 << 5)];
            acc1 = fma((scalar_t)(-0.64549720287322998), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)53 << 5)];
            scalar_t yv  = y[y_base + 1];
            scalar_t gov = grad_out[go_base + ((int64_t)230 << 5)];
            acc1 = fma((scalar_t)(0.35355338454246521), wv * (yv * gov), acc1);
        }
        ...
        {
            scalar_t wv  = w[w_base + ((int64_t)54 << 5)];
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)238 << 5)];
            acc1 = fma((scalar_t)(0.40824830532073975), wv * (yv * gov), acc1);
        }
    ...
    // ============================================================
    {
...

        {
            ...
            scalar_t yv  = y[y_base + 4];
            scalar_t gov = grad_out[go_base + ((int64_t)40 << 5)];
            acc1 = fma((scalar_t)(-0.11952286213636398), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 6];
            scalar_t gov = grad_out[go_base + ((int64_t)38 << 5)];
            acc1 = fma((scalar_t)(0.41403934359550476), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)50 << 5)];
            acc0 = fma((scalar_t)(0.23145502805709839), wv * (yv * gov), acc0);
        }

        {
            ...
            scalar_t yv  = y[y_base + 10];
            scalar_t gov = grad_out[go_base + ((int64_t)50 << 5)];
            acc1 = fma((scalar_t)(0.29880714416503906), wv * (yv * gov), acc1);
        }

        {
            ...
            scalar_t yv  = y[y_base + 11];
            scalar_t gov = grad_out[go_base + ((int64_t)50 << 5)];
            acc0 = fma((scalar_t)(-0.29880714416503906), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 13];
            scalar_t gov = grad_out[go_base + ((int64_t)51 << 5)];
            acc1 = fma((scalar_t)(-0.18898224830627441), wv * (yv * gov), acc1);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 14];
            scalar_t gov = grad_out[go_base + ((int64_t)51 << 5)];
            acc0 = fma((scalar_t)(-0.37796449661254883), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)136 << 5)];
            acc0 = fma((scalar_t)(0.38575837016105652), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 9];
            scalar_t gov = grad_out[go_base + ((int64_t)238 << 5)];
            acc0 = fma((scalar_t)(-0.40824830532073975), wv * (yv * gov), acc0);
        }
    ...
    // ============================================================
    {
...

        {
            ...
            scalar_t yv  = y[y_base + 5];
            scalar_t gov = grad_out[go_base + ((int64_t)38 << 5)];
            acc0 = fma((scalar_t)(-0.29276999831199646), wv * (yv * gov), acc0);
        }
...

        {
            ...
            scalar_t yv  = y[y_base + 12];
            scalar_t gov = grad_out[go_base + ((int64_t)135 << 5)];
            acc0 = fma((scalar_t)(0.43643578886985779), wv * (yv * gov), acc0);
        }
...
template <typename scalar_t>
__launch_bounds__(32, 8) __global__ void uniform1d_split_regalloc_u32_path777_bwd_grady(
    const scalar_t* __restrict__ grad_out,
    const scalar_t* __restrict__ w,
    const scalar_t* __restrict__ x_all,
    ...
    int B, int Iw, int Ix, int Ky, int V)
{
    ...
    }
    {
        ...
        local_k_1 = fma((scalar_t)(-0.31622779369354248) * w_i_16, x_j_12 * go_v_32, local_k_1);
    }
    {
        scalar_t w_i_16  = w[w_base + ((int64_t)16 << 5)];
        scalar_t x_j_14  = x_all[x_base + ((int64_t)14 << 5)];
    ...
    }
    {
        ...
        local_k_1 = fma((scalar_t)(-0.15430335700511932) * w_i_38, x_j_19 * go_v_128, local_k_1);
    }
    {
        scalar_t w_i_38  = w[w_base + ((int64_t)38 << 5)];
        scalar_t x_j_21  = x_all[x_base + ((int64_t)21 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
        scalar_t go_v_132 = grad_out[go_base + ((int64_t)132 << 5)];
        local_k_1 = fma((scalar_t)(0.15430335700511932) * w_i_38, x_j_17 * go_v_132, local_k_1);
    }
    {
    ...
    }
    {
        ...
        local_k_1 = fma((scalar_t)(-0.4472135603427887) * w_i_46, x_j_11 * go_v_183, local_k_1);
    }
    {
        scalar_t w_i_46  = w[w_base + ((int64_t)46 << 5)];
        scalar_t x_j_10  = x_all[x_base + ((int64_t)10 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
        scalar_t go_v_230 = grad_out[go_base + ((int64_t)230 << 5)];
        local_k_1 = fma((scalar_t)(-0.4564354419708252) * w_i_53, x_j_17 * go_v_230, local_k_1);
    }
    {
        scalar_t w_i_53  = w[w_base + ((int64_t)53 << 5)];
        scalar_t x_j_16  = x_all[x_base + ((int64_t)16 << 5)];
        scalar_t go_v_231 = grad_out[go_base + ((int64_t)231 << 5)];
        local_k_1 = fma((scalar_t)(0.4564354419708252) * w_i_53, x_j_16 * go_v_231, local_k_1);
    }
    {
        scalar_t w_i_53  = w[w_base + ((int64_t)53 << 5)];
        scalar_t x_j_19  = x_all[x_base + ((int64_t)19 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_20  = x_all[x_base + ((int64_t)20 << 5)];
        scalar_t go_v_233 = grad_out[go_base + ((int64_t)233 << 5)];
        local_k_1 = fma((scalar_t)(0.4564354419708252) * w_i_53, x_j_20 * go_v_233, local_k_1);
    }
    {
        scalar_t w_i_53  = w[w_base + ((int64_t)53 << 5)];
        scalar_t x_j_19  = x_all[x_base + ((int64_t)19 << 5)];
        scalar_t go_v_234 = grad_out[go_base + ((int64_t)234 << 5)];
        local_k_1 = fma((scalar_t)(-0.4564354419708252) * w_i_53, x_j_19 * go_v_234, local_k_1);
    }
    {
        scalar_t w_i_53  = w[w_base + ((int64_t)53 << 5)];
        scalar_t x_j_21  = x_all[x_base + ((int64_t)21 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_12  = x_all[x_base + ((int64_t)12 << 5)];
        scalar_t go_v_33 = grad_out[go_base + ((int64_t)33 << 5)];
        local_k_2 = fma((scalar_t)(0.63245558738708496) * w_i_16, x_j_12 * go_v_33, local_k_2);
    }
    {
        scalar_t w_i_16  = w[w_base + ((int64_t)16 << 5)];
        scalar_t x_j_13  = x_all[x_base + ((int64_t)13 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
        scalar_t go_v_129 = grad_out[go_base + ((int64_t)129 << 5)];
        local_k_2 = fma((scalar_t)(0.61721342802047729) * w_i_38, x_j_17 * go_v_129, local_k_2);
    }
    {
        scalar_t w_i_38  = w[w_base + ((int64_t)38 << 5)];
        scalar_t x_j_18  = x_all[x_base + ((int64_t)18 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_19  = x_all[x_base + ((int64_t)19 << 5)];
        scalar_t go_v_131 = grad_out[go_base + ((int64_t)131 << 5)];
        local_k_2 = fma((scalar_t)(0.61721342802047729) * w_i_38, x_j_19 * go_v_131, local_k_2);
    }
    {
        scalar_t w_i_38  = w[w_base + ((int64_t)38 << 5)];
        scalar_t x_j_20  = x_all[x_base + ((int64_t)20 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_12  = x_all[x_base + ((int64_t)12 << 5)];
        scalar_t go_v_34 = grad_out[go_base + ((int64_t)34 << 5)];
        local_k_3 = fma((scalar_t)(-0.31622779369354248) * w_i_16, x_j_12 * go_v_34, local_k_3);
    }
    {
        scalar_t w_i_16  = w[w_base + ((int64_t)16 << 5)];
        scalar_t x_j_14  = x_all[x_base + ((int64_t)14 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
        scalar_t go_v_128 = grad_out[go_base + ((int64_t)128 << 5)];
        local_k_3 = fma((scalar_t)(-0.15430335700511932) * w_i_38, x_j_17 * go_v_128, local_k_3);
    }
    {
        scalar_t w_i_38  = w[w_base + ((int64_t)38 << 5)];
        scalar_t x_j_16  = x_all[x_base + ((int64_t)16 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_19  = x_all[x_base + ((int64_t)19 << 5)];
        scalar_t go_v_132 = grad_out[go_base + ((int64_t)132 << 5)];
        local_k_3 = fma((scalar_t)(-0.15430335700511932) * w_i_38, x_j_19 * go_v_132, local_k_3);
    }
    {
        scalar_t w_i_38  = w[w_base + ((int64_t)38 << 5)];
        scalar_t x_j_21  = x_all[x_base + ((int64_t)21 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_13  = x_all[x_base + ((int64_t)13 << 5)];
        scalar_t go_v_183 = grad_out[go_base + ((int64_t)183 << 5)];
        local_k_3 = fma((scalar_t)(-0.4472135603427887) * w_i_46, x_j_13 * go_v_183, local_k_3);
    }
    {
        scalar_t w_i_46  = w[w_base + ((int64_t)46 << 5)];
        scalar_t x_j_12  = x_all[x_base + ((int64_t)12 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_19  = x_all[x_base + ((int64_t)19 << 5)];
        scalar_t go_v_230 = grad_out[go_base + ((int64_t)230 << 5)];
        local_k_3 = fma((scalar_t)(0.4564354419708252) * w_i_53, x_j_19 * go_v_230, local_k_3);
    }
    {
        scalar_t w_i_53  = w[w_base + ((int64_t)53 << 5)];
        scalar_t x_j_21  = x_all[x_base + ((int64_t)21 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_20  = x_all[x_base + ((int64_t)20 << 5)];
        scalar_t go_v_231 = grad_out[go_base + ((int64_t)231 << 5)];
        local_k_3 = fma((scalar_t)(0.4564354419708252) * w_i_53, x_j_20 * go_v_231, local_k_3);
    }
    {
        scalar_t w_i_53  = w[w_base + ((int64_t)53 << 5)];
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_16  = x_all[x_base + ((int64_t)16 << 5)];
        scalar_t go_v_233 = grad_out[go_base + ((int64_t)233 << 5)];
        local_k_3 = fma((scalar_t)(-0.4564354419708252) * w_i_53, x_j_16 * go_v_233, local_k_3);
    }
    {
        scalar_t w_i_53  = w[w_base + ((int64_t)53 << 5)];
        scalar_t x_j_15  = x_all[x_base + ((int64_t)15 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
        scalar_t go_v_234 = grad_out[go_base + ((int64_t)234 << 5)];
        local_k_3 = fma((scalar_t)(-0.4564354419708252) * w_i_53, x_j_17 * go_v_234, local_k_3);
    }
    {
        scalar_t w_i_53  = w[w_base + ((int64_t)53 << 5)];
        scalar_t x_j_16  = x_all[x_base + ((int64_t)16 << 5)];
    ...
    }
    {
        ...
        local_k_4 = fma((scalar_t)(0.4472135603427887) * w_i_49, x_j_19 * go_v_203, local_k_4);
    }
    {
        scalar_t w_i_49  = w[w_base + ((int64_t)49 << 5)];
        scalar_t x_j_21  = x_all[x_base + ((int64_t)21 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
        scalar_t go_v_205 = grad_out[go_base + ((int64_t)205 << 5)];
        local_k_4 = fma((scalar_t)(0.4472135603427887) * w_i_49, x_j_17 * go_v_205, local_k_4);
    }
    {
        scalar_t w_i_49  = w[w_base + ((int64_t)49 << 5)];
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
    ...
    }
    {
        ...
        local_k_4 = fma((scalar_t)(-0.49999997019767761) * w_i_52, x_j_11 * go_v_222, local_k_4);
    }
    {
        scalar_t w_i_52  = w[w_base + ((int64_t)52 << 5)];
        scalar_t x_j_11  = x_all[x_base + ((int64_t)11 << 5)];
    ...
    }
    {
        ...
        local_k_4 = fma((scalar_t)(-0.49999997019767761) * w_i_52, x_j_13 * go_v_228, local_k_4);
    }
    ...
    }
    {
        ...
        scalar_t x_j_12  = x_all[x_base + ((int64_t)12 << 5)];
        scalar_t go_v_49 = grad_out[go_base + ((int64_t)49 << 5)];
        local_k_5 = fma((scalar_t)(-0.54772251844406128) * w_i_21, x_j_12 * go_v_49, local_k_5);
    }
    {
        scalar_t w_i_21  = w[w_base + ((int64_t)21 << 5)];
        scalar_t x_j_14  = x_all[x_base + ((int64_t)14 << 5)];
    ...
    }
    {
        ...
        local_k_5 = fma((scalar_t)(-0.4472135603427887) * w_i_44, x_j_4 * go_v_172, local_k_5);
    }
    {
        scalar_t w_i_45  = w[w_base + ((int64_t)45 << 5)];
        scalar_t x_j_5  = x_all[x_base + ((int64_t)5 << 5)];
        scalar_t go_v_173 = grad_out[go_base + ((int64_t)173 << 5)];
        local_k_5 = fma((scalar_t)(-0.4472135603427887) * w_i_45, x_j_5 * go_v_173, local_k_5);
    }
    {
        scalar_t w_i_44  = w[w_base + ((int64_t)44 << 5)];
        scalar_t x_j_4  = x_all[x_base + ((int64_t)4 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_20  = x_all[x_base + ((int64_t)20 << 5)];
        scalar_t go_v_201 = grad_out[go_base + ((int64_t)201 << 5)];
        local_k_5 = fma((scalar_t)(0.4564354419708252) * w_i_49, x_j_20 * go_v_201, local_k_5);
    }
    {
        scalar_t w_i_49  = w[w_base + ((int64_t)49 << 5)];
        scalar_t x_j_19  = x_all[x_base + ((int64_t)19 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_21  = x_all[x_base + ((int64_t)21 << 5)];
        scalar_t go_v_202 = grad_out[go_base + ((int64_t)202 << 5)];
        local_k_5 = fma((scalar_t)(-0.4564354419708252) * w_i_49, x_j_21 * go_v_202, local_k_5);
    }
    {
        scalar_t w_i_49  = w[w_base + ((int64_t)49 << 5)];
        scalar_t x_j_18  = x_all[x_base + ((int64_t)18 << 5)];
    ...
    }
    {
        ...
        local_k_5 = fma((scalar_t)(0.4564354419708252) * w_i_49, x_j_15 * go_v_206, local_k_5);
    }
    {
        scalar_t w_i_49  = w[w_base + ((int64_t)49 << 5)];
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_16  = x_all[x_base + ((int64_t)16 << 5)];
        scalar_t go_v_207 = grad_out[go_base + ((int64_t)207 << 5)];
        local_k_5 = fma((scalar_t)(-0.4564354419708252) * w_i_49, x_j_16 * go_v_207, local_k_5);
    }
    {
        scalar_t w_i_52  = w[w_base + ((int64_t)52 << 5)];
        scalar_t x_j_10  = x_all[x_base + ((int64_t)10 << 5)];
        scalar_t go_v_222 = grad_out[go_base + ((int64_t)222 << 5)];
        local_k_5 = fma((scalar_t)(0.49999997019767761) * w_i_52, x_j_10 * go_v_222, local_k_5);
    }
    {
        scalar_t w_i_52  = w[w_base + ((int64_t)52 << 5)];
        scalar_t x_j_10  = x_all[x_base + ((int64_t)10 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_12  = x_all[x_base + ((int64_t)12 << 5)];
        scalar_t go_v_226 = grad_out[go_base + ((int64_t)226 << 5)];
        local_k_5 = fma((scalar_t)(-0.4472135603427887) * w_i_52, x_j_12 * go_v_226, local_k_5);
    }
    {
        scalar_t w_i_52  = w[w_base + ((int64_t)52 << 5)];
        scalar_t x_j_14  = x_all[x_base + ((int64_t)14 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_14  = x_all[x_base + ((int64_t)14 << 5)];
        scalar_t go_v_228 = grad_out[go_base + ((int64_t)228 << 5)];
        local_k_5 = fma((scalar_t)(0.49999997019767761) * w_i_52, x_j_14 * go_v_228, local_k_5);
    }
    ...
    }
    {
        ...
        scalar_t x_j_4  = x_all[x_base + ((int64_t)4 << 5)];
        scalar_t go_v_26 = grad_out[go_base + ((int64_t)26 << 5)];
        local_k_6 = fma((scalar_t)(-0.31622779369354248) * w_i_14, x_j_4 * go_v_26, local_k_6);
    }
    {
        scalar_t w_i_15  = w[w_base + ((int64_t)15 << 5)];
        scalar_t x_j_5  = x_all[x_base + ((int64_t)5 << 5)];
        scalar_t go_v_27 = grad_out[go_base + ((int64_t)27 << 5)];
        local_k_6 = fma((scalar_t)(-0.31622779369354248) * w_i_15, x_j_5 * go_v_27, local_k_6);
    }
    {
        scalar_t w_i_14  = w[w_base + ((int64_t)14 << 5)];
        scalar_t x_j_6  = x_all[x_base + ((int64_t)6 << 5)];
        scalar_t go_v_28 = grad_out[go_base + ((int64_t)28 << 5)];
        local_k_6 = fma((scalar_t)(0.63245558738708496) * w_i_14, x_j_6 * go_v_28, local_k_6);
    }
    {
        scalar_t w_i_15  = w[w_base + ((int64_t)15 << 5)];
        scalar_t x_j_7  = x_all[x_base + ((int64_t)7 << 5)];
        scalar_t go_v_29 = grad_out[go_base + ((int64_t)29 << 5)];
        local_k_6 = fma((scalar_t)(0.63245558738708496) * w_i_15, x_j_7 * go_v_29, local_k_6);
    }
    {
        scalar_t w_i_14  = w[w_base + ((int64_t)14 << 5)];
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
        scalar_t go_v_30 = grad_out[go_base + ((int64_t)30 << 5)];
        local_k_6 = fma((scalar_t)(-0.31622779369354248) * w_i_14, x_j_8 * go_v_30, local_k_6);
    }
    {
        scalar_t w_i_15  = w[w_base + ((int64_t)15 << 5)];
        scalar_t x_j_9  = x_all[x_base + ((int64_t)9 << 5)];
        scalar_t go_v_31 = grad_out[go_base + ((int64_t)31 << 5)];
        local_k_6 = fma((scalar_t)(-0.31622779369354248) * w_i_15, x_j_9 * go_v_31, local_k_6);
    }
    {
        scalar_t w_i_18  = w[w_base + ((int64_t)18 << 5)];
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_13  = x_all[x_base + ((int64_t)13 << 5)];
        scalar_t go_v_47 = grad_out[go_base + ((int64_t)47 << 5)];
        local_k_6 = fma((scalar_t)(-0.54772251844406128) * w_i_21, x_j_13 * go_v_47, local_k_6);
    }
    {
        scalar_t w_i_21  = w[w_base + ((int64_t)21 << 5)];
        scalar_t x_j_11  = x_all[x_base + ((int64_t)11 << 5)];
        scalar_t go_v_49 = grad_out[go_base + ((int64_t)49 << 5)];
        local_k_6 = fma((scalar_t)(0.54772251844406128) * w_i_21, x_j_11 * go_v_49, local_k_6);
    }
    {
        scalar_t w_i_23  = w[w_base + ((int64_t)23 << 5)];
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_13  = x_all[x_base + ((int64_t)13 << 5)];
        scalar_t go_v_224 = grad_out[go_base + ((int64_t)224 << 5)];
        local_k_6 = fma((scalar_t)(-0.4472135603427887) * w_i_52, x_j_13 * go_v_224, local_k_6);
    }
    {
        scalar_t w_i_52  = w[w_base + ((int64_t)52 << 5)];
        scalar_t x_j_11  = x_all[x_base + ((int64_t)11 << 5)];
        scalar_t go_v_226 = grad_out[go_base + ((int64_t)226 << 5)];
        local_k_6 = fma((scalar_t)(0.4472135603427887) * w_i_52, x_j_11 * go_v_226, local_k_6);
    }
    {
        scalar_t w_i_52  = w[w_base + ((int64_t)52 << 5)];
        scalar_t x_j_10  = x_all[x_base + ((int64_t)10 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_12  = x_all[x_base + ((int64_t)12 << 5)];
        scalar_t go_v_47 = grad_out[go_base + ((int64_t)47 << 5)];
        local_k_7 = fma((scalar_t)(0.54772251844406128) * w_i_21, x_j_12 * go_v_47, local_k_7);
    }
    {
        scalar_t w_i_21  = w[w_base + ((int64_t)21 << 5)];
        scalar_t x_j_14  = x_all[x_base + ((int64_t)14 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
        scalar_t go_v_172 = grad_out[go_base + ((int64_t)172 << 5)];
        local_k_7 = fma((scalar_t)(-0.4472135603427887) * w_i_44, x_j_8 * go_v_172, local_k_7);
    }
    {
        scalar_t w_i_45  = w[w_base + ((int64_t)45 << 5)];
        scalar_t x_j_9  = x_all[x_base + ((int64_t)9 << 5)];
        scalar_t go_v_173 = grad_out[go_base + ((int64_t)173 << 5)];
        local_k_7 = fma((scalar_t)(-0.4472135603427887) * w_i_45, x_j_9 * go_v_173, local_k_7);
    }
    {
        scalar_t w_i_44  = w[w_base + ((int64_t)44 << 5)];
        scalar_t x_j_6  = x_all[x_base + ((int64_t)6 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_16  = x_all[x_base + ((int64_t)16 << 5)];
        scalar_t go_v_201 = grad_out[go_base + ((int64_t)201 << 5)];
        local_k_7 = fma((scalar_t)(0.4564354419708252) * w_i_49, x_j_16 * go_v_201, local_k_7);
    }
    {
        scalar_t w_i_49  = w[w_base + ((int64_t)49 << 5)];
        scalar_t x_j_15  = x_all[x_base + ((int64_t)15 << 5)];
        scalar_t go_v_202 = grad_out[go_base + ((int64_t)202 << 5)];
        local_k_7 = fma((scalar_t)(0.4564354419708252) * w_i_49, x_j_15 * go_v_202, local_k_7);
    }
    {
        scalar_t w_i_49  = w[w_base + ((int64_t)49 << 5)];
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_21  = x_all[x_base + ((int64_t)21 << 5)];
        scalar_t go_v_206 = grad_out[go_base + ((int64_t)206 << 5)];
        local_k_7 = fma((scalar_t)(0.4564354419708252) * w_i_49, x_j_21 * go_v_206, local_k_7);
    }
    {
        scalar_t w_i_49  = w[w_base + ((int64_t)49 << 5)];
        scalar_t x_j_20  = x_all[x_base + ((int64_t)20 << 5)];
        scalar_t go_v_207 = grad_out[go_base + ((int64_t)207 << 5)];
        local_k_7 = fma((scalar_t)(0.4564354419708252) * w_i_49, x_j_20 * go_v_207, local_k_7);
    }
    {
        scalar_t w_i_52  = w[w_base + ((int64_t)52 << 5)];
        scalar_t x_j_14  = x_all[x_base + ((int64_t)14 << 5)];
        scalar_t go_v_222 = grad_out[go_base + ((int64_t)222 << 5)];
        local_k_7 = fma((scalar_t)(-0.49999997019767761) * w_i_52, x_j_14 * go_v_222, local_k_7);
    }
    {
        scalar_t w_i_52  = w[w_base + ((int64_t)52 << 5)];
        scalar_t x_j_12  = x_all[x_base + ((int64_t)12 << 5)];
        scalar_t go_v_224 = grad_out[go_base + ((int64_t)224 << 5)];
        local_k_7 = fma((scalar_t)(0.4472135603427887) * w_i_52, x_j_12 * go_v_224, local_k_7);
    }
    {
        scalar_t w_i_52  = w[w_base + ((int64_t)52 << 5)];
        scalar_t x_j_14  = x_all[x_base + ((int64_t)14 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_10  = x_all[x_base + ((int64_t)10 << 5)];
        scalar_t go_v_228 = grad_out[go_base + ((int64_t)228 << 5)];
        local_k_7 = fma((scalar_t)(0.49999997019767761) * w_i_52, x_j_10 * go_v_228, local_k_7);
    }
    ...
    }
    {
        ...
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
        scalar_t go_v_203 = grad_out[go_base + ((int64_t)203 << 5)];
        local_k_8 = fma((scalar_t)(-0.4472135603427887) * w_i_49, x_j_17 * go_v_203, local_k_8);
    }
    {
        scalar_t w_i_49  = w[w_base + ((int64_t)49 << 5)];
        scalar_t x_j_20  = x_all[x_base + ((int64_t)20 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_19  = x_all[x_base + ((int64_t)19 << 5)];
        scalar_t go_v_205 = grad_out[go_base + ((int64_t)205 << 5)];
        local_k_8 = fma((scalar_t)(0.4472135603427887) * w_i_49, x_j_19 * go_v_205, local_k_8);
    }
    {
        scalar_t w_i_49  = w[w_base + ((int64_t)49 << 5)];
        scalar_t x_j_21  = x_all[x_base + ((int64_t)21 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_13  = x_all[x_base + ((int64_t)13 << 5)];
        scalar_t go_v_222 = grad_out[go_base + ((int64_t)222 << 5)];
        local_k_8 = fma((scalar_t)(0.49999997019767761) * w_i_52, x_j_13 * go_v_222, local_k_8);
    }
    {
        scalar_t w_i_52  = w[w_base + ((int64_t)52 << 5)];
        scalar_t x_j_12  = x_all[x_base + ((int64_t)12 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_11  = x_all[x_base + ((int64_t)11 << 5)];
        scalar_t go_v_228 = grad_out[go_base + ((int64_t)228 << 5)];
        local_k_8 = fma((scalar_t)(-0.49999997019767761) * w_i_52, x_j_11 * go_v_228, local_k_8);
    }
    ...
    }
    {
        ...
        local_k_9 = fma((scalar_t)(0.4564354419708252) * w_i_47, x_j_13 * go_v_188, local_k_9);
    }
    {
        scalar_t w_i_47  = w[w_base + ((int64_t)47 << 5)];
        scalar_t x_j_14  = x_all[x_base + ((int64_t)14 << 5)];
    ...
    }
    {
        ...
        local_k_9 = fma((scalar_t)(0.4564354419708252) * w_i_47, x_j_11 * go_v_192, local_k_9);
    }
    {
    ...
    }
    {
        ...
        scalar_t x_j_13  = x_all[x_base + ((int64_t)13 << 5)];
        scalar_t go_v_187 = grad_out[go_base + ((int64_t)187 << 5)];
        local_k_10 = fma((scalar_t)(0.4564354419708252) * w_i_47, x_j_13 * go_v_187, local_k_10);
    }
    {
        scalar_t w_i_47  = w[w_base + ((int64_t)47 << 5)];
        scalar_t x_j_13  = x_all[x_base + ((int64_t)13 << 5)];
    ...
    }
    {
        ...
        local_k_10 = fma((scalar_t)(-0.4564354419708252) * w_i_47, x_j_11 * go_v_193, local_k_10);
    }
    {
        scalar_t w_i_50  = w[w_base + ((int64_t)50 << 5)];
        scalar_t x_j_4  = x_all[x_base + ((int64_t)4 << 5)];
    ...
    }
    {
        ...
        local_k_10 = fma((scalar_t)(-0.4564354419708252) * w_i_50, x_j_4 * go_v_212, local_k_10);
    }
    {
        scalar_t w_i_51  = w[w_base + ((int64_t)51 << 5)];
        scalar_t x_j_5  = x_all[x_base + ((int64_t)5 << 5)];
        scalar_t go_v_213 = grad_out[go_base + ((int64_t)213 << 5)];
        local_k_10 = fma((scalar_t)(-0.4564354419708252) * w_i_51, x_j_5 * go_v_213, local_k_10);
    }
    {
        scalar_t w_i_50  = w[w_base + ((int64_t)50 << 5)];
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
        scalar_t go_v_216 = grad_out[go_base + ((int64_t)216 << 5)];
        local_k_10 = fma((scalar_t)(0.4564354419708252) * w_i_50, x_j_8 * go_v_216, local_k_10);
    }
    {
        scalar_t w_i_51  = w[w_base + ((int64_t)51 << 5)];
        scalar_t x_j_9  = x_all[x_base + ((int64_t)9 << 5)];
        scalar_t go_v_217 = grad_out[go_base + ((int64_t)217 << 5)];
        local_k_10 = fma((scalar_t)(0.4564354419708252) * w_i_51, x_j_9 * go_v_217, local_k_10);
    }
    {
        scalar_t w_i_50  = w[w_base + ((int64_t)50 << 5)];
        scalar_t x_j_6  = x_all[x_base + ((int64_t)6 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
        scalar_t go_v_108 = grad_out[go_base + ((int64_t)108 << 5)];
        local_k_11 = fma((scalar_t)(-0.15430335700511932) * w_i_34, x_j_8 * go_v_108, local_k_11);
    }
    {
        scalar_t w_i_35  = w[w_base + ((int64_t)35 << 5)];
        scalar_t x_j_9  = x_all[x_base + ((int64_t)9 << 5)];
        scalar_t go_v_109 = grad_out[go_base + ((int64_t)109 << 5)];
        local_k_11 = fma((scalar_t)(-0.15430335700511932) * w_i_35, x_j_9 * go_v_109, local_k_11);
    }
    {
        scalar_t w_i_34  = w[w_base + ((int64_t)34 << 5)];
        scalar_t x_j_6  = x_all[x_base + ((int64_t)6 << 5)];
        scalar_t go_v_110 = grad_out[go_base + ((int64_t)110 << 5)];
        local_k_11 = fma((scalar_t)(0.61721342802047729) * w_i_34, x_j_6 * go_v_110, local_k_11);
    }
    {
        scalar_t w_i_35  = w[w_base + ((int64_t)35 << 5)];
        scalar_t x_j_7  = x_all[x_base + ((int64_t)7 << 5)];
        scalar_t go_v_111 = grad_out[go_base + ((int64_t)111 << 5)];
        local_k_11 = fma((scalar_t)(0.61721342802047729) * w_i_35, x_j_7 * go_v_111, local_k_11);
    }
    {
        scalar_t w_i_34  = w[w_base + ((int64_t)34 << 5)];
        scalar_t x_j_4  = x_all[x_base + ((int64_t)4 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_4  = x_all[x_base + ((int64_t)4 << 5)];
        scalar_t go_v_116 = grad_out[go_base + ((int64_t)116 << 5)];
        local_k_11 = fma((scalar_t)(0.15430335700511932) * w_i_34, x_j_4 * go_v_116, local_k_11);
    }
    {
        scalar_t w_i_35  = w[w_base + ((int64_t)35 << 5)];
        scalar_t x_j_5  = x_all[x_base + ((int64_t)5 << 5)];
        scalar_t go_v_117 = grad_out[go_base + ((int64_t)117 << 5)];
        local_k_11 = fma((scalar_t)(0.15430335700511932) * w_i_35, x_j_5 * go_v_117, local_k_11);
    }
    {
        scalar_t w_i_39  = w[w_base + ((int64_t)39 << 5)];
        scalar_t x_j_19  = x_all[x_base + ((int64_t)19 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_18  = x_all[x_base + ((int64_t)18 << 5)];
        scalar_t go_v_134 = grad_out[go_base + ((int64_t)134 << 5)];
        local_k_11 = fma((scalar_t)(0.15430335700511932) * w_i_39, x_j_18 * go_v_134, local_k_11);
    }
    {
        scalar_t w_i_39  = w[w_base + ((int64_t)39 << 5)];
        scalar_t x_j_20  = x_all[x_base + ((int64_t)20 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_14  = x_all[x_base + ((int64_t)14 << 5)];
        scalar_t go_v_189 = grad_out[go_base + ((int64_t)189 << 5)];
        local_k_11 = fma((scalar_t)(-0.4472135603427887) * w_i_47, x_j_14 * go_v_189, local_k_11);
    }
    {
        scalar_t w_i_47  = w[w_base + ((int64_t)47 << 5)];
        scalar_t x_j_11  = x_all[x_base + ((int64_t)11 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_10  = x_all[x_base + ((int64_t)10 << 5)];
        scalar_t go_v_191 = grad_out[go_base + ((int64_t)191 << 5)];
        local_k_11 = fma((scalar_t)(0.4472135603427887) * w_i_47, x_j_10 * go_v_191, local_k_11);
    }
    {
        scalar_t w_i_47  = w[w_base + ((int64_t)47 << 5)];
        scalar_t x_j_11  = x_all[x_base + ((int64_t)11 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_4  = x_all[x_base + ((int64_t)4 << 5)];
        scalar_t go_v_210 = grad_out[go_base + ((int64_t)210 << 5)];
        local_k_11 = fma((scalar_t)(0.4564354419708252) * w_i_50, x_j_4 * go_v_210, local_k_11);
    }
    {
        scalar_t w_i_51  = w[w_base + ((int64_t)51 << 5)];
        scalar_t x_j_5  = x_all[x_base + ((int64_t)5 << 5)];
        scalar_t go_v_211 = grad_out[go_base + ((int64_t)211 << 5)];
        local_k_11 = fma((scalar_t)(0.4564354419708252) * w_i_51, x_j_5 * go_v_211, local_k_11);
    }
    {
        scalar_t w_i_50  = w[w_base + ((int64_t)50 << 5)];
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
        scalar_t go_v_218 = grad_out[go_base + ((int64_t)218 << 5)];
        local_k_11 = fma((scalar_t)(0.4564354419708252) * w_i_50, x_j_8 * go_v_218, local_k_11);
    }
    {
        scalar_t w_i_51  = w[w_base + ((int64_t)51 << 5)];
        scalar_t x_j_9  = x_all[x_base + ((int64_t)9 << 5)];
        scalar_t go_v_219 = grad_out[go_base + ((int64_t)219 << 5)];
        local_k_11 = fma((scalar_t)(0.4564354419708252) * w_i_51, x_j_9 * go_v_219, local_k_11);
    }
    {
        scalar_t w_i_54  = w[w_base + ((int64_t)54 << 5)];
        scalar_t x_j_16  = x_all[x_base + ((int64_t)16 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_17  = x_all[x_base + ((int64_t)17 << 5)];
        scalar_t go_v_134 = grad_out[go_base + ((int64_t)134 << 5)];
        local_k_12 = fma((scalar_t)(0.15430335700511932) * w_i_39, x_j_17 * go_v_134, local_k_12);
    }
    {
        scalar_t w_i_39  = w[w_base + ((int64_t)39 << 5)];
        scalar_t x_j_18  = x_all[x_base + ((int64_t)18 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_19  = x_all[x_base + ((int64_t)19 << 5)];
        scalar_t go_v_136 = grad_out[go_base + ((int64_t)136 << 5)];
        local_k_12 = fma((scalar_t)(0.15430335700511932) * w_i_39, x_j_19 * go_v_136, local_k_12);
    }
    {
        scalar_t w_i_39  = w[w_base + ((int64_t)39 << 5)];
        scalar_t x_j_20  = x_all[x_base + ((int64_t)20 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_4  = x_all[x_base + ((int64_t)4 << 5)];
        scalar_t go_v_108 = grad_out[go_base + ((int64_t)108 << 5)];
        local_k_13 = fma((scalar_t)(-0.15430335700511932) * w_i_34, x_j_4 * go_v_108, local_k_13);
    }
    {
        scalar_t w_i_35  = w[w_base + ((int64_t)35 << 5)];
        scalar_t x_j_5  = x_all[x_base + ((int64_t)5 << 5)];
        scalar_t go_v_109 = grad_out[go_base + ((int64_t)109 << 5)];
        local_k_13 = fma((scalar_t)(-0.15430335700511932) * w_i_35, x_j_5 * go_v_109, local_k_13);
    }
    {
        scalar_t w_i_34  = w[w_base + ((int64_t)34 << 5)];
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_6  = x_all[x_base + ((int64_t)6 << 5)];
        scalar_t go_v_114 = grad_out[go_base + ((int64_t)114 << 5)];
        local_k_13 = fma((scalar_t)(0.61721342802047729) * w_i_34, x_j_6 * go_v_114, local_k_13);
    }
    {
        scalar_t w_i_35  = w[w_base + ((int64_t)35 << 5)];
        scalar_t x_j_7  = x_all[x_base + ((int64_t)7 << 5)];
        scalar_t go_v_115 = grad_out[go_base + ((int64_t)115 << 5)];
        local_k_13 = fma((scalar_t)(0.61721342802047729) * w_i_35, x_j_7 * go_v_115, local_k_13);
    }
    {
        scalar_t w_i_34  = w[w_base + ((int64_t)34 << 5)];
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
        scalar_t go_v_116 = grad_out[go_base + ((int64_t)116 << 5)];
        local_k_13 = fma((scalar_t)(-0.15430335700511932) * w_i_34, x_j_8 * go_v_116, local_k_13);
    }
    {
        scalar_t w_i_35  = w[w_base + ((int64_t)35 << 5)];
        scalar_t x_j_9  = x_all[x_base + ((int64_t)9 << 5)];
        scalar_t go_v_117 = grad_out[go_base + ((int64_t)117 << 5)];
        local_k_13 = fma((scalar_t)(-0.15430335700511932) * w_i_35, x_j_9 * go_v_117, local_k_13);
    }
    {
        scalar_t w_i_39  = w[w_base + ((int64_t)39 << 5)];
        scalar_t x_j_15  = x_all[x_base + ((int64_t)15 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_18  = x_all[x_base + ((int64_t)18 << 5)];
        scalar_t go_v_136 = grad_out[go_base + ((int64_t)136 << 5)];
        local_k_13 = fma((scalar_t)(0.15430335700511932) * w_i_39, x_j_18 * go_v_136, local_k_13);
    }
    {
        scalar_t w_i_39  = w[w_base + ((int64_t)39 << 5)];
        scalar_t x_j_20  = x_all[x_base + ((int64_t)20 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_10  = x_all[x_base + ((int64_t)10 << 5)];
        scalar_t go_v_189 = grad_out[go_base + ((int64_t)189 << 5)];
        local_k_13 = fma((scalar_t)(0.4472135603427887) * w_i_47, x_j_10 * go_v_189, local_k_13);
    }
    {
        scalar_t w_i_47  = w[w_base + ((int64_t)47 << 5)];
        scalar_t x_j_13  = x_all[x_base + ((int64_t)13 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_14  = x_all[x_base + ((int64_t)14 << 5)];
        scalar_t go_v_191 = grad_out[go_base + ((int64_t)191 << 5)];
        local_k_13 = fma((scalar_t)(0.4472135603427887) * w_i_47, x_j_14 * go_v_191, local_k_13);
    }
    {
        scalar_t w_i_47  = w[w_base + ((int64_t)47 << 5)];
        scalar_t x_j_13  = x_all[x_base + ((int64_t)13 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
        scalar_t go_v_210 = grad_out[go_base + ((int64_t)210 << 5)];
        local_k_13 = fma((scalar_t)(-0.4564354419708252) * w_i_50, x_j_8 * go_v_210, local_k_13);
    }
    {
        scalar_t w_i_51  = w[w_base + ((int64_t)51 << 5)];
        scalar_t x_j_9  = x_all[x_base + ((int64_t)9 << 5)];
        scalar_t go_v_211 = grad_out[go_base + ((int64_t)211 << 5)];
        local_k_13 = fma((scalar_t)(-0.4564354419708252) * w_i_51, x_j_9 * go_v_211, local_k_13);
    }
    {
        scalar_t w_i_50  = w[w_base + ((int64_t)50 << 5)];
        scalar_t x_j_6  = x_all[x_base + ((int64_t)6 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_4  = x_all[x_base + ((int64_t)4 << 5)];
        scalar_t go_v_218 = grad_out[go_base + ((int64_t)218 << 5)];
        local_k_13 = fma((scalar_t)(0.4564354419708252) * w_i_50, x_j_4 * go_v_218, local_k_13);
    }
    {
        scalar_t w_i_51  = w[w_base + ((int64_t)51 << 5)];
        scalar_t x_j_5  = x_all[x_base + ((int64_t)5 << 5)];
        scalar_t go_v_219 = grad_out[go_base + ((int64_t)219 << 5)];
        local_k_13 = fma((scalar_t)(0.4564354419708252) * w_i_51, x_j_5 * go_v_219, local_k_13);
    }
    {
        scalar_t w_i_54  = w[w_base + ((int64_t)54 << 5)];
        scalar_t x_j_20  = x_all[x_base + ((int64_t)20 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_11  = x_all[x_base + ((int64_t)11 << 5)];
        scalar_t go_v_187 = grad_out[go_base + ((int64_t)187 << 5)];
        local_k_14 = fma((scalar_t)(0.4564354419708252) * w_i_47, x_j_11 * go_v_187, local_k_14);
    }
    {
        scalar_t w_i_47  = w[w_base + ((int64_t)47 << 5)];
        scalar_t x_j_11  = x_all[x_base + ((int64_t)11 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_13  = x_all[x_base + ((int64_t)13 << 5)];
        scalar_t go_v_193 = grad_out[go_base + ((int64_t)193 << 5)];
        local_k_14 = fma((scalar_t)(0.4564354419708252) * w_i_47, x_j_13 * go_v_193, local_k_14);
    }
    {
        scalar_t w_i_50  = w[w_base + ((int64_t)50 << 5)];
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_8  = x_all[x_base + ((int64_t)8 << 5)];
        scalar_t go_v_212 = grad_out[go_base + ((int64_t)212 << 5)];
        local_k_14 = fma((scalar_t)(-0.4564354419708252) * w_i_50, x_j_8 * go_v_212, local_k_14);
    }
    {
        scalar_t w_i_51  = w[w_base + ((int64_t)51 << 5)];
        scalar_t x_j_9  = x_all[x_base + ((int64_t)9 << 5)];
        scalar_t go_v_213 = grad_out[go_base + ((int64_t)213 << 5)];
        local_k_14 = fma((scalar_t)(-0.4564354419708252) * w_i_51, x_j_9 * go_v_213, local_k_14);
    }
    {
        scalar_t w_i_50  = w[w_base + ((int64_t)50 << 5)];
        scalar_t x_j_4  = x_all[x_base + ((int64_t)4 << 5)];
        scalar_t go_v_216 = grad_out[go_base + ((int64_t)216 << 5)];
        local_k_14 = fma((scalar_t)(-0.4564354419708252) * w_i_50, x_j_4 * go_v_216, local_k_14);
    }
    {
        scalar_t w_i_51  = w[w_base + ((int64_t)51 << 5)];
        scalar_t x_j_5  = x_all[x_base + ((int64_t)5 << 5)];
        scalar_t go_v_217 = grad_out[go_base + ((int64_t)217 << 5)];
        local_k_14 = fma((scalar_t)(-0.4564354419708252) * w_i_51, x_j_5 * go_v_217, local_k_14);
    }
    {
        scalar_t w_i_50  = w[w_base + ((int64_t)50 << 5)];
        scalar_t x_j_4  = x_all[x_base + ((int64_t)4 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_11  = x_all[x_base + ((int64_t)11 << 5)];
        scalar_t go_v_188 = grad_out[go_base + ((int64_t)188 << 5)];
        local_k_15 = fma((scalar_t)(-0.4564354419708252) * w_i_47, x_j_11 * go_v_188, local_k_15);
    }
    {
        scalar_t w_i_47  = w[w_base + ((int64_t)47 << 5)];
        scalar_t x_j_10  = x_all[x_base + ((int64_t)10 << 5)];
    ...
    }
    {
        ...
        scalar_t x_j_13  = x_all[x_base + ((int64_t)13 << 5)];
        scalar_t go_v_192 = grad_out[go_base + ((int64_t)192 << 5)];
        local_k_15 = fma((scalar_t)(0.4564354419708252) * w_i_47, x_j_13 * go_v_192, local_k_15);
    }
    {
        scalar_t w_i_47  = w[w_base + ((int64_t)47 << 5)];
        scalar_t x_j_12  = x_all[x_base + ((int64_t)12 << 5)];
...
std::vector<torch::Tensor> uniform1d_split_regalloc_u32_path777_bwd(
    ...
    int64_t V)
{
    ...
    AT_DISPATCH_FLOATING_TYPES(w.scalar_type(), "uniform1d_split_regalloc_u32_path777_bwd", [&] {
        uniform1d_split_regalloc_u32_path777_bwd_gradw<scalar_t><<<grid, block, 0, stream>>>(
        ...
        uniform1d_split_regalloc_u32_path777_bwd_gradx<scalar_t><<<grid, block, 0, stream>>>(
            grad_out.data_ptr<scalar_t>(),
            w.data_ptr<scalar_t>(),
            y.data_ptr<scalar_t>(),
        ...
        uniform1d_split_regalloc_u32_path777_bwd_grady<scalar_t><<<grid, block, 0, stream>>>(
            grad_out.data_ptr<scalar_t>(),
            w.data_ptr<scalar_t>(),
            x_all.data_ptr<scalar_t>(),
...
TORCH_LIBRARY(uniform1d_split_regalloc_u32_path777_bwd_codegen, m) {
    m.def("run", &uniform1d_split_regalloc_u32_path777_bwd);
}
