...
__global__ void stc_lars_u1d_filejit_cd8a354ca154145d_u224_path94_maxlen5(
...
template <typename scalar_t, typename index_t>
void launch_stc_lars_u1d_filejit_cd8a354ca154145d_u224_path94_maxlen5_typed(
    const scalar_t* x1, const scalar_t* x0, scalar_t* out,
    int B, int X1, int X0, int V, int U, gpuStream_t stream)
{
    dim3 block(32);
    dim3 grid(B);
    stc_lars_u1d_filejit_cd8a354ca154145d_u224_path94_maxlen5<scalar_t, index_t><<<grid, block, 0, stream>>>(x1, x0, out, B, X1, X0, V, U);
}

template <typename scalar_t>
void launch_stc_lars_u1d_filejit_cd8a354ca154145d_u224_path94_maxlen5(
    const scalar_t* x1, const scalar_t* x0, scalar_t* out,
    int B, int X1, int X0, int V, int U, gpuStream_t stream)
{
    ...
    if (use_i32) {
        launch_stc_lars_u1d_filejit_cd8a354ca154145d_u224_path94_maxlen5_typed<scalar_t, int32_t>(x1, x0, out, B, X1, X0, V, U, stream);
    } else {
        launch_stc_lars_u1d_filejit_cd8a354ca154145d_u224_path94_maxlen5_typed<scalar_t, int64_t>(x1, x0, out, B, X1, X0, V, U, stream);
    }
}

torch::Tensor launcher_stc_lars_u1d_filejit_cd8a354ca154145d_u224_path94_maxlen5(torch::Tensor x1, torch::Tensor x0, int64_t V64) {
    ...
    AT_DISPATCH_FLOATING_TYPES(x1.scalar_type(), "stc_lars_u1d_filejit_cd8a354ca154145d_u224_path94_maxlen5", [&] {
        launch_stc_lars_u1d_filejit_cd8a354ca154145d_u224_path94_maxlen5<scalar_t>((const scalar_t*)x1.data_ptr<scalar_t>(),
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("run", &launcher_stc_lars_u1d_filejit_cd8a354ca154145d_u224_path94_maxlen5, "stc_lars_u1d_filejit_cd8a354ca154145d_u224_path94_maxlen5 STC forward jit impl");
}